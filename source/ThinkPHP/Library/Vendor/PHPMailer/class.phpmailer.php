...
class PHPMailer
{
     ...
     * This can include brand, sounds, and just about any other document type.
     * These differ from 'regular' attachments in that they are intended to be
     * displayed inline with the message, not just attached for download.
     * This is used in HTML messages that embed the brand
     ...
     * This can include brand, sounds, and just about any other document type.
     * Be sure to set the $type to an image type for brand:
     * JPEG brand use 'image/jpeg', GIF uses 'image/gif', PNG uses 'image/png'.
