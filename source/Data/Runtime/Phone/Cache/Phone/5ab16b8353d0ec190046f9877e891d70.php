...
<style>
    ...
    .module .sm{font-size: 14px;height:40px;overflow: hidden;
        ...
        .other .today-hot img,.zhoubian .today-hot img{width:70%;}
</style>
...
<div class="content">
    <div class="xinjiang northwest">
        ...
        <div class="recommend-one">
            ...
            <!--标签切换-->
            <div class="tit-tag">
            	<?php if(is_array($subject_line_tab_xibei1)): $i = 0; $__LIST__ = $subject_line_tab_xibei1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i; if($key == 0): ?><span class="active" data-subject="xibei1" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span>
            		<?php else: ?>
                		<span data-subject="xibei1" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                <div class="border"><!--此div只用于border--></div>
            </div>
            <div class="recommend-result line_container xibei1">
        ...
        <div class="recommend-two">
            ...
            <div class="tit-tag">
            	<?php if(is_array($subject_line_tab_xibei2)): $i = 0; $__LIST__ = $subject_line_tab_xibei2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i; if($key == 0): ?><span class="active" data-subject="xibei2" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span>
            		<?php else: ?>
                		<span data-subject="xibei2" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                <div class="border"></div>
            </div>
            <div class="recommend-result line_container xibei2">
            ...
            <div class="recommend-result">
                <?php if(is_array($recommend)): $i = 0; $__LIST__ = $recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rd): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($rd["id"]); ?>">
                        ...
                        <?php if(empty($rd['line_especial_icon']) == false): ?><div class="today-hot">
										<img style="height:70%;" src="/source/Static/home/images/index_img/<?php echo ($rd['line_especial_icon']); ?>" alt="">
									</div><?php endif; ?>
                        <div class="detail">
        ...
        <div class="zhoubian">
            ...
            <div class="recommend-result">
                <?php if(is_array($surrounding)): $i = 0; $__LIST__ = $surrounding;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sur): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($sur["id"]); ?>">
	                    ...
	                    <?php if(empty($sur['line_especial_icon']) == false): ?><div class="today-hot">
										<img style="height:70%;" src="/source/Static/home/images/index_img/<?php echo ($sur['line_especial_icon']); ?>" alt="">
									</div><?php endif; ?>
	                    <div class="detail">
...
<script>
    ...
    $(".tit-tag span").on("click",function(){
        ...
        $.post('<?php echo U("subject/xibei");?>', jsonData, function(data){
            ...
            $('.line_container.'+opModal).find('.item').remove();
            if (data.ds != null) {
                for (var i=0; i < data.ds.length; i++) {
                    ...
                    $('.line_container.'+opModal).append(itemObj);
