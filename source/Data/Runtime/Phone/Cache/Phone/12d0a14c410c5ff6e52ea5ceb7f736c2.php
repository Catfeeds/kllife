...
<link rel="stylesheet" href="/source/Static/phone/css/list.css">
<style>
...
<div>
	<div class="phone index list">
		<div class="top" style="z-index:100;background: #fff;">
			<img style="width:100%;" class="img-responsive" src="/source/Static/qlpphone/images/list/top-image.jpg" alt="">
		</div>
		<div class="travel">
			<img style="width:100%;" src="/source/Static/qlpphone/images/index/phone+.jpg" alt="">
			...
			<div class="line-list">
				<?php if(is_array($lines)): $i = 0; $__LIST__ = $lines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$line): $mod = ($i % 2 );++$i;?><a href="<?php echo U('line/info');?>/id/<?php echo ($line["id"]); ?>">
						<div class="item">
							...
							<p class="price">
								<?php if(empty($line['check_price'])): ?><span>核算中</span>
								<?php else: ?>
									¥<span><?php echo ($line["start_price_adult"]); ?></span>元起<?php endif; ?>
							</p>
