...
<div class="page">
	...
	<link rel="stylesheet" href="/source/Static/phone/css/images.css">
		<header class="bar bar-nav">
			<a class="button button-link button-nav pull-left back" href="<?php echo U('line/article');?>">
		      <i class="iconfont">&#xe606;</i>
		    </a>
		    <h1 class="title"><?php echo ($article["short_title"]); ?></h1>
		</header>
...
//            });
		...
		<div class="content">
			<?php if(!empty($article["face_image"])): ?><div class="images-top">
					<img src="<?php echo ($article["face_image"]); ?>" alt="">
				</div><?php endif; ?>
			
			<div class="images-content">
				<div class="content-padded">
					<h4><img src="/source/Static/phone/images/index/images.png" alt=""><?php echo ($article["title"]); ?></h4>
