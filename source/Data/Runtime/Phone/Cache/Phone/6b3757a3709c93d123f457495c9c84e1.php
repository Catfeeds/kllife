...
<body>
	...
	<!-- mycss -->
	<link rel="stylesheet" href="/source/Static/phone/css/pay_result.css">
	<div class="page">
		<header class="bar bar-nav">
			<a class="button button-link button-nav pull-left back" href="javascript:;">
		      <i class="iconfont">&#xe606;</i>
		    </a>
			<?php if(empty($err_msg) == false): ?><h1 class="title">支付失败</h1>
			<?php else: ?>				
		    	<h1 class="title">支付成功</h1><?php endif; ?>
		</header>
...
//            });
		...
		<div class="content">
			<div class="success-img">
				<?php if(empty($err_msg) == false): ?><img src="/source/Static/phone/images/pay_result/fail.png" alt="">
					<p>订单已支付失败！</p>
				<?php else: ?>
					<img src="/source/Static/phone/images/pay_result/ok.png" alt="">
			...
			<div class="pay-success">
				<div class="pay-success-details">
					...
					<div class="pay-warning">
						<p>
							<img src="/source/Static/phone/images/pay_result/warn.png" alt="">
