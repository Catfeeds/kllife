    ...
    <div class="content">
        <div class="xinjiang">
            ...
            <!--<div class="recommend">
                ...
                <div class="recommend1 find_line" data-op="dest"><img src="/source/Static/phone/images/xinjiang/Recommend1.png" alt=""></div>
                <div class="recommend2 find_line" data-op="dest" data-tab="line_theme_xtmlx"><img src="/source/Static/phone/images/xinjiang/Recommend2.png" alt=""></div>
                <div class="recommend3 find_line" data-op="dest" data-tab="line_theme_sheying"><img src="/source/Static/phone/images/xinjiang/Recommend3.png" alt=""></div>
                <div class="recommend4 find_line" data-op="dest" data-tab="line_theme_qlp"><img src="/source/Static/phone/images/xinjiang/Recommend4.png" alt=""></div>
            </div>-->
            <!--<div class="recommend-result line_container dest">
            	<?php if(is_array($dest_line_xinjiang)): $i = 0; $__LIST__ = $dest_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($l["id"]); ?>">
	        ...
	        <div class="recommend-two">
	            ...
	            <div class="tit-tag">
                	<?php if(is_array($subject_line_tab_xinjiang)): $i = 0; $__LIST__ = $subject_line_tab_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i; if($key == 0): ?><span class="find_line active" data-op="subject" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span>
                		<?php else: ?>
                			<span class="find_line" data-op="subject" data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
	            </div>
	            <div class="recommend-result line_container subject">
	            	<?php if(is_array($subject_line_xinjiang)): $i = 0; $__LIST__ = $subject_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="item">
		                    <img class="img-responsive" src="<?php echo ($l["img1"]); ?>" alt="">
		                    <?php if(empty($l['line_especial_icon']) == false): ?><div class="today-hot">
										<img src="/source/Static/home/images/index_img/<?php echo ($l['line_especial_icon']); ?>" alt="">
									</div><?php endif; ?>
		                    ...
		                    <div class="price">
		                        ...
		                        <span class="right">
		                            <?php if(empty($l['check_price'])): ?><span class="money">核算中</span>
		                                <?php else: ?>
		                                ￥<span class="money"><?php echo ($l["start_price_adult"]); ?></span>元起 (成人)<?php endif; ?>	                            
	                            </span>
		                    </div>
		                    <a href="<?php echo U('line/info');?>/id/<?php echo ($l["id"]); ?>" external></a>
		                </div><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <?php if(!empty($qrcode)): ?><div style="margin-bottom:60px;">
	        	<p style="text-align: center;">长按二维码了解更多</p>
	        	<img style="width:90%;display:block;margin:auto;" src="/source/Static/phone/images/xinjiang/xinjiang-ewm.png" alt="" />
	        	<p style="text-align: center;">微信号：lxtour</p>
	        </div><?php endif; ?>
...
//    findLine(null, null);  
    ...
    function findLine(vop, vtheme) {
    	...
    	$.post('<?php echo U("subject/xinjiang");?>', jsonData, function(data){
    		$('.line_container.'+vop).children().remove();
    		if (data.ds != null) {
    			for (var i=0; i < data.ds.length; i++) {
    				...
    				if (d.order_member_count != null) {
    					$(rootObj).find('.detail').append('<p class="sm">本线路已有 <span>'+d.order_member_count+'</span> 人已报名</p>')	
    				}
    				...
    				$('.line_container.'+vop).append(rootObj);
                    console.log(rootObj)
    			}
    		} else {
    			$('.line_container.'+vop).html('<div style="text-align: center; font-size:20px;">亲，没有您要的线路，可以选择定制或者尝试其他选项哦</div>');
    		}
    	});
    }
    $('.find_line').click(function(){
    	var opType = $(this).attr('data-op');
    	var themeType = $(this).attr('data-tab');
    	findLine(opType, themeType);
    });
</script>
<!--百度统计-->
<script>
