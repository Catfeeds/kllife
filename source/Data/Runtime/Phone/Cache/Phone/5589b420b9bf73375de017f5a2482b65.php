...
//            });
    ...
    <div class="content">
        ...
        <div class="module01">
            <div class="swiper-container" >
                <div class="swiper-wrapper">
                    <?php $__FOR_START_1728074017__=1;$__FOR_END_1728074017__=7;for($i=$__FOR_START_1728074017__;$i <= $__FOR_END_1728074017__;$i+=1){ $img = $set['lunbo'.$i]; $url = $set['lunbo'.$i.'_url']; ?>
        ...
        <!--<div class="special">
            ...
            <?php $__FOR_START_2133303431__=0;$__FOR_END_2133303431__=4;for($i=$__FOR_START_2133303431__;$i < $__FOR_END_2133303431__;$i+=1){ $rowClass = intval($i / 2) == 0 ? 'border-bottom: 1px solid #dcdcdc;' : ''; $zt = $set['zhuanti'.$i]; ?>
        ...
        <div class="hot-sale">
            ...
            <div class="recommend-result">
                <div class="item">
                    <span class="img-width"><img class="img-responsive background-img-loading" data-echo="/source/Static/phone/images/northwest/img.jpg" alt=""></span>
                    <div class="detail">
                        <p class="lg">大美九色</p>
                        <p class="sm">本线路已有 <span>250</span> 人已报名</p>
                    </div>
                    <div class="price">
                        <span class="right">￥<span class="money">5800</span>元起</span>
                    </div>
        ...
        <div class="destination">
            <div class="recommend-result">
                <div class="item">
                    <img class="img-responsive background-img-loading" data-echo="http://img.kllife.com/2017-06-27_5951f11367708.jpg" alt="">
                    <div class="detail">
                        <p class="lg">丝绸之路全景游9日</p>
                        <p class="sm subheading">西宁-塔尔寺-青海湖-茶卡盐湖-水上魔鬼城-莫高窟-鸣沙山月牙泉-张掖丹霞-卓尔山9日游</p>
                        <p class="sm">本线路已有 <span>250</span> 人已报名</p>
                    </div>
                    <div class="price">
            ...
            $(document).on( "scroll", function() {
                ...
                if( startPos <= p ){
                    ...
                    $('#j-bournBox').css({'position':'fixed',
                        ...
                        'width':'100%',
                        'z-index':'999'});
                    $(".destination").css("margin-top","130px")
                }else{
                    //清除固定
