...
<div class="page">
	<!-- mycss -->
	<link rel="stylesheet" href="/source/Static/phone/css/order_center.css">
					...
					<div id="tab1" class="tab active">
						<?php if(is_array($all_orders)): $i = 0; $__LIST__ = $all_orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><div class="order-sublist">
								<div class="card-footer">
									<a href="#" class="link">
										<img src="/source/Static/phone/images/order_center/sublist_logo.png" alt="">订单号：<?php echo ($order["order_sn"]); ?>
									</a>
							    </div>
							    	...
							    	<div class="content-padded">
							    		...
							    		<p>
											...
											<?php else: ?>
												...
												<!--<p><a href="http://kllife.com/fpdf/domo/pdf.php?did=<?php echo ($order["id"]); ?>" target="_blank">下载</a></p>--><?php endif; ?>
							    		</p>
							    	</div>
							    </div>
				...
				if (data.ds == null || data.ds == 'undefined') {
					...
					for(var i=0; i < data.ds.length; i++) {
						...
						var vhtml = '<div class="order-sublist">'+
									'	<div class="card-footer">'+
									'		<a href="#" class="link">'+
									'			<img src="/source/Static/phone/images/order_center/sublist_logo.png" alt="">订单号：'+d.order_sn+
									'		</a>'+
