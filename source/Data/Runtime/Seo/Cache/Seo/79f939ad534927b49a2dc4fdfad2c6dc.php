						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-5" style="padding-right:0px;">
										<div class="input-group">										
											<input type="number" class="form-control" maxlength="11" value="<?php echo ($user["phone"]); ?>" />
									...
									<div class="col-sm-3" style="padding-left:0px;">
										<div class="input-group">
											<input type="number" style="width:130px;" class="form-control" maxlength="6" placeholder="请输入手机验证码" />
											<span class="input-group-addon" style="width:90px;">
								...
								<div class="form-group">
									...
									<div class="col-sm-5" style="padding-right:0px;">
										<div class="input-group">
											<input type="email" style="width:509px;" class="form-control" value="<?php echo ($user["email"]); ?>"/>
											<span class="input-group-addon" style="width:90px;">
									...
									<div class="col-sm-3" style="padding-left:0px;">
										<div class="input-group">
											<input type="text" style="width:130px;" class="form-control" maxlength="6" placeholder="请输入邮箱验证码" />
											<span class="input-group-addon" style="width:90px;">
