					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["old_lineid_title"]); ?></span>						
							</div>
							<div class="form-group row">
								<p class="col-sm-1">线路批次：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["old_hdid_show_text"]); ?></span>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<p class="col-sm-1">修改线路：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["lineid_title"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">修改批次：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["hdid_show_text"]); ?></span>
							</div>
...
//		console.log(JSON.stringify(jsonData));		
		...
		$.post('<?php echo U("review/changeLine");?>', jsonData, function(data){
			...
			if (data.result.errno == 0) {
				alert('订单审核操作成功');
				location.href = '<?php echo U("review/changeLine");?>';
			} else {
				alert(data.result.message);
