		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"> 
					...
					<input id="taocan_id" type="hidden" value="<?php echo ($taocan["id"]); ?>"/>
				</h3>
			</div>
			...
			<div class="panel-body row">
				<div id="dingdan_main" class="col-sm-12">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" name="taocan_name" id="taocan_name" value="<?php echo ($taocan["name"]); ?>" placeholder="请输入套餐名称" />
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
					...
					<div class="row">											
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control autogrow" name="taocan_desc" id="taocan_desc" placeholder="请输入套餐描述"><?php echo ($taocan["desc"]); ?></textarea>
							</div>
						</div>					
					</div>
					...
					<div class="row">							
						<div class="col-md-8">
							<div class="form-group">
								<?php if(empty($taocan['id'])): ?><button class="btn btn-secondary save_taocan">保存套餐信息</button>
								<?php else: ?>
								<button class="btn btn-secondary edit_taocan">更新套餐信息</button><?php endif; ?>
							</div>							
						</div>	
					</div>					
				</div>
...
<script type="text/javascript">	
	...
	function initLine() {	
		...
		setSelect2Value('#taocan_type', '<?php echo ($taocan["type"]); ?>');
		showLoading(false);
	}
	...
	$('.save_taocan').click(function(){
		...
		$.post('<?php echo U("line/taocan");?>',jsonData,
		function(backdata,status) {
			console.log(JSON.stringify(backdata));
	        if (backdata['result']['errno'] == 0) {
	            toastr.success(backdata.result.message);
	            window.location.href = "<?php echo U('line/taocan');?>";
	        }else{
