...
//						});
	...
	<div class="lubo set_root">
		<ul class="lubo_box">
			<li data-set="lunbo1" style=" opacity: 1;filter:alpha(opacity=100);"><a href="javascript:;" style="background-image:url(<?php echo ($set["lunbo1"]); ?>); background-size: 100% 100%;"></a></li>
			<li data-set="lunbo2"><a href="javascript:;" style="background-image:url(<?php echo ($set["lunbo2"]); ?>); background-size: 100% 100%;"></a></li>
			<li data-set="lunbo3"><a href="javascript:;" style="background-image:url(<?php echo ($set["lunbo3"]); ?>); background-size: 100% 100%;"></a></li>
		</ul>
	</div>
	...
	<div class="bg-gray">
		<div class="special main">
			...
			<div class="special-exhibition">
				<ul>
					<?php $__FOR_START_1167247500__=0;$__FOR_END_1167247500__=4;for($k=$__FOR_START_1167247500__;$k < $__FOR_END_1167247500__;$k+=1){ if($k % 4 == 0): ?><li><?php endif; ?>						
							<?php $zt = $set['zhuanti'.$k] ?>
							<a class="special-exhibition-product" data-set="zhuanti<?php echo ($k); ?>" data-index="<?php echo ($k); ?>">
								<img class="circle_img" src="<?php echo ($zt["img_main"]); ?>" alt="">
								<div class="special-exhibition-describe">
									<h4 class="title"><?php echo ($zt["title"]); ?></h4>
									<h4 class="subheading"><?php echo ($zt["desc"]); ?></h4>
									<p class="desc"><?php echo ($zt["desc"]); ?></p>
								</div>
								<div class="special-exhibition-write">
									<p>
										<span>主标题：</span>
										<input type="text" maxlength="4" value="<?php echo ($zt["title"]); ?>"/>
									</p>
									<p>
										<span>描述：</span>
										<input type="text" maxlength="10" value="<?php echo ($zt["desc"]); ?>"/>
									</p>
