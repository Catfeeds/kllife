			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"> 
						...
						<input id="team_id" type="hidden" value="<?php echo ($team["id"]); ?>"/>
					</h3>
				</div>
					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="row dingdan_bottom">
								...
								<span id="destination_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["destination"]); ?></span>
								<input type="text" id="destination_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="destination" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="destination" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							<div class="row dingdan_bottom">
								<p class="col-sm-1">出行人数：</p>
								<span id="member_count_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["member_count"]); ?></span>
								<input type="text" id="member_count_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="member_count" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="member_count" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							<div class="row dingdan_bottom">
								<p class="col-sm-1">联系人：</p>
								<span id="linkman_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["linkman"]); ?></span>
								<input type="text" id="linkman_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="linkman" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="linkman" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">联系人电话：</p>
								<span id="tel_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["tel"]); ?></span>
								<input type="text" id="tel_val" maxlength="11" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="tel" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="tel" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">微信：</p>
								<span id="weixin_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["weixin"]); ?></span>
								<input type="text" id="weixin_val" maxlength="31" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="weixin" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="weixin" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>	
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">联系人QQ：</p>
								<span id="qq_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["qq"]); ?></span>
								<input type="text" id="qq_val" maxlength="11" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="qq" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="qq" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>	
													
							<div class="row dingdan_bottom">
								<p class="cantuanrenshu col-sm-1">出行日期：</p>
								<span id="start_date_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["start_date"]); ?></span>		
								...
								<?php if($grant_update_team == true): ?><input type="button" name="start_date" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="start_date" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>						
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">游玩天数：</p>
								<span id="days_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["days"]); ?>天</span>
								<input type="text" id="days_val" maxlength="63" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="days" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="days" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">包团来源：</p>
								<span id="from_id_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["from_id_type_desc"]); ?></span>
								<div id="from_id_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="from_id_val" class="form-control">
										<?php if(is_array($teamFrom)): $i = 0; $__LIST__ = $teamFrom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$from): $mod = ($i % 2 );++$i;?><option value="<?php echo ($from["id"]); ?>"><?php echo ($from["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="from_id" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="from_id" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">处理结果：</p>
								<span id="team_result_show" class="col-sm-3" style="padding-left: 0; float: left; color: red;"><?php echo ($team["team_result_type_desc"]); ?></span>
								<div id="team_result_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="team_result_val" class="form-control">
										<?php if(is_array($team_proc_result)): $i = 0; $__LIST__ = $team_proc_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><option value="<?php echo ($result["id"]); ?>"><?php echo ($result["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="team_result" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="team_result" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">住宿酒店条件：</p>
								<span id="hotel_request_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["hotel_request_type_desc"]); ?></span>
								<div id="hotel_request_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="hotel_request_val" class="form-control">
										<?php if(is_array($hotel_request)): $i = 0; $__LIST__ = $hotel_request;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotel): $mod = ($i % 2 );++$i;?><option value="<?php echo ($hotel["id"]); ?>"><?php echo ($hotel["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="hotel_request" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="hotel_request" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">领队要求：</p>
								<span id="leader_request_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["leader_request_type_desc"]); ?></span>
								<div id="leader_request_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="leader_request_val" class="form-control">
										<?php if(is_array($leader_request)): $i = 0; $__LIST__ = $leader_request;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leader): $mod = ($i % 2 );++$i;?><option value="<?php echo ($leader["id"]); ?>"><?php echo ($leader["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="leader_request" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="leader_request" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<!--<div class="row form-group">
								<p class="col-sm-1">车辆要求：</p>
								<span id="car_request_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["car_request_type_desc"]); ?></span>
								<div id="car_request_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="car_request_val" class="form-control">
										<?php if(is_array($car_request)): $i = 0; $__LIST__ = $car_request;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$car): $mod = ($i % 2 );++$i;?><option value="<?php echo ($car["id"]); ?>"><?php echo ($car["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="car_request" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="car_request" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>-->
							
							<div class="row form-group">
								<p class="col-sm-1">特色服务：</p>
								<span id="especial_request_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["especial_request_type_desc"]); ?></span>
								<div id="especial_request_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="especial_request_val" class="form-control">
										<?php if(is_array($especial_request)): $i = 0; $__LIST__ = $especial_request;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$especial): $mod = ($i % 2 );++$i;?><option value="<?php echo ($especial["id"]); ?>"><?php echo ($especial["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="especial_request" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="especial_request" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">联系时间：</p>
								<span id="contact_time_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["contact_time_type_desc"]); ?></span>
								<div id="contact_time_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="contact_time_val" class="form-control">
										<?php if(is_array($contact_time)): $i = 0; $__LIST__ = $contact_time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contact): $mod = ($i % 2 );++$i;?><option value="<?php echo ($contact["id"]); ?>"><?php echo ($contact["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="contact_time" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="contact_time" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">其他联系方式：</p>
								<span id="other_contact_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["other_contact"]); ?></span>
								<input type="text" id="other_contact_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true): ?><input type="button" name="other_contact" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="other_contact" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">其他需求：</p>
								<span id="other_request_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["other_request"]); ?></span>
								<textarea id="other_request_val" class="dingdan_bianji col-sm-8"></textarea>
								<?php if($grant_update_team == true): ?><input type="button" name="other_request" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="other_request" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">接手管理员：</p>
								<span class="col-sm-3" style="padding-left: 0;"><?php echo ($team["dispose_admin_id_show_text"]); ?></span>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">包团状态：</p>
								<span class="col-sm-3" style="padding-left: 0;"><?php echo ($team["dispose_state_id_type_desc"]); ?></span>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">行程标题：</p>
								<span id="title_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["title"]); ?></span>
								<input type="text" id="title_val" style="height: 32px;" class="dingdan_bianji col-sm-8">
								<?php if($grant_update_team == true or $grant_force_team == true): ?><input type="button" name="title" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="title" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">成人价格：</p>
								<span id="price_adult_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["price_adult"]); ?></span>
								<input type="text" id="price_adult_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true or $grant_force_team == true): ?><input type="button" name="price_adult" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="price_adult" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">小孩价格：</p>
								<span id="price_child_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["price_child"]); ?></span>
								<input type="text" id="price_child_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_team == true or $grant_force_team == true): ?><input type="button" name="price_child" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="price_child" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">去程交通：</p>
								<span id="go_traffic_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["go_traffic_type_desc"]); ?></span>
								<div id="go_traffic_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
									...
									<select id="go_traffic_val" class="form-control">
										<?php if(is_array($traffic_tools)): $i = 0; $__LIST__ = $traffic_tools;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$traffic): $mod = ($i % 2 );++$i;?><option value="<?php echo ($traffic["id"]); ?>"><?php echo ($traffic["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
								<?php if($grant_update_team == true): ?><input type="button" name="go_traffic" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="go_traffic" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row form-group">
								<p class="col-sm-1">回程交通：</p>
								<span id="back_traffic_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["back_traffic_type_desc"]); ?></span>
								...
								<?php if($grant_update_team == true): ?><input type="button" name="back_traffic" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="back_traffic" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
													
							<div class="form-group row">
								<p class="cantuanrenshu col-sm-1">集合时间：</p>
								<span id="meet_time_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($team["meet_time"]); ?></span>	
...
//									    $("#meet_time_container").datetimepicker({
								...
								<?php if($grant_update_team == true): ?><input type="button" name="meet_time" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="meet_time" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>					
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">集合地点：</p>
								<span id="meet_addr_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["meet_addr"]); ?></span>
								<input type="text" id="meet_addr_val" style="height: 32px;" class="dingdan_bianji col-sm-8">
								<?php if($grant_update_team == true): ?><input type="button" name="meet_addr" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="meet_addr" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="form-group row">
								<p class="col-sm-1">集合须知：</p>
								<span id="meet_intro_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($team["meet_intro"]); ?></span>
								<textarea id="meet_intro_val" class="dingdan_bianji col-sm-8"></textarea>
								<?php if($grant_update_team == true): ?><input type="button" name="meet_intro" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="meet_intro" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>	
							...
							<div class="col-sm-12" style=" margin-top: 2%;">	
								...
								<?php if($grant_update_team == true): ?><div class="row">					
								...
								<div class="row">
									<table id="table_message" class="table text-left" style="width: 80%;">
										<thead>
											...
											<tbody>
												<?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?><tr>
						...
						<br />
						<br />
						<?php if($grant_list_scheduling == true): ?><button id="add_scheduling" class="btn btn-info">行程管理</button><?php endif; ?>
						<?php if($grant_update_team == true): ?><button id="create_order" class="btn btn-warning">生成订单</button><?php endif; ?>
						<?php if(empty($order) == false): ?><a href="<?php echo U('order/info');?>/id/<?php echo ($order["id"]); ?>" class="btn btn-secondary" target="_blank">订单详细</a><?php endif; ?>
...
<script type="text/javascript">
	...
	function ajaxAppendOrderMessage(content) {
		...
		$.post('<?php echo U("team/info");?>', jsonData, function(data){
			if (data.result.errno == 0) {
				var s = data['message'];
				var html = '';
					html += '<tr>';
	...
	function addScheduling() {
		...
		$.getJSON('<?php echo U("team/scheduling");?>', {op:'info_url', id:teamId}, function(data){
			if (data.result.errno == 0) {
				location.href = data.jumpUrl;
			} else {
				alert(data.result.message);
	...
	function createTeamOrder() {
		...
		var w = window.open();
		$.post('<?php echo U("team/order");?>', {op:'jump_order', id:teamId}, function(data){
			if (data.jumpUrl != null) {
