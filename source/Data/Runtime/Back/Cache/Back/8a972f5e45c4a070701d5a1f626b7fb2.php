...
//													toastr.error(resp.result.message, "登录失败!", opts);
				...
				<form method="post" role="form" id="login" class="login-form fade-in-effect">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control input-dark" name="acct" id="acct" autocomplete="off" />
					</div>
					...
					<!--<div class="form-group">-->
						...
						<!--<select class="btn-primary form-control selectpicker" id="sboxit-1">
							<?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type["id"]); ?>"><?php echo ($type["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>-->
					<!--</div>-->
					<div class="form-group">
