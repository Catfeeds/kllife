	...
	<div id="content">
		<div class="img-text-content">
			...
			<div class="img-text-information">
				...
				<!-- 主要内容 -->
				<?php if(is_array($article['content'])): $i = 0; $__LIST__ = $article['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cnt): $mod = ($i % 2 );++$i;?><div class="img-text-information-content">
						<?php if(empty($cnt['image_url']) == false): if($cnt['image_url'] != $article['face_image']): ?><div class="img-information">
									<span>
										<img src="<?php echo ($cnt["image_url"]); ?>" alt="">
									</span>
								</div><?php endif; ?>
						<?php else: ?>
							<div class="text-information">
								<?php echo ($cnt["content"]); ?>
							</div><?php endif; ?>
