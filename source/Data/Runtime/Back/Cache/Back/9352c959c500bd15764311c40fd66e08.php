...
.video-product-content i { position: absolute; display: inline-block; width: 31px; height: 23px; left: 14px; bottom: 9px; background-image: url(/source/Static/home/images/index_img/video_stop.png); background-size: 100% 100%; }
.video-product-content:hover i { background-image: url(/source/Static/home/images/index_img/video_play.png); }
...
.iframeTop > a:hover { -o-transform: rotate(0deg); -moz-transform: rotate(0deg); -ms-transform: rotate(0deg); -webkit-transform: rotate(0deg); transform: rotate(0deg); }
	...
	<div class="video-modal video-product-content hidden_ctrl" data-id="0">
		<img class="delete-video" src="/source/Static/home/images/index_img/x.png" alt="">
		<a class="video_href" href="javascript:;" onclick="addIframe('绝美外观视频','http://www.haofangyuan.net/youku/videoyk.jsp?token=v&auto=yes&id=XMTYzMDkxMDU0NA==');">
			<img class="video_face" src="/source/Static/home/images/index_img/video01.png" alt="">
			<i></i>
		</a>
	...
	<div class="video-modal video-product-content hidden_ctrl" data-id="0">
		<img class="delete-video meipai" src="/source/Static/home/images/index_img/x.png" alt="">
	...
	<div class="video">
		<div class="video-product">
			<ul>
				<?php if(is_array($videos)): $i = 0; $__LIST__ = $videos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
						<div class="video-product-content" data-id="<?php echo ($v["id"]); ?>" data-url="<?php echo ($v["href"]); ?>">
							<u class="btn edit-video">编辑</u>
							<u class="btn delete-video">删除</u>
							<a href="javascript:;">
								<img class="face_image" src="<?php echo ($v["img"]); ?>" alt="">
								<i></i>
							</a>
							<div class="video-product-content-describe">
								<h5 class="title" data-val="<?php echo ($v["title"]); ?>"><a href="javascript:;" onclick="addIframe('<?php echo ($v["title"]); ?>','<?php echo ($v["href"]); ?>')"><?php echo ($v["title_show"]); ?></a></h5>
								<p class="sub" data-val="<?php echo ($v["subheading"]); ?>"><?php echo ($v["subheading_show"]); ?></p>
							</div>
						</div>
	...
	<script>	
		...
		constructionPage('.list-page', 1, '<?php echo ($page_count); ?>', changeVideoPage, true);
		...
		$('.video-sure').find('button').click(function(){
			...
			$.post('<?php echo U("line/video");?>', jsonData, function(data){
				if (data.result.errno == 0) {
					location.href = '<?php echo U("line/video");?>'
//					if (data.ds != null && data.ds != 'undefined') {
//						var d = data.ds;
//						var rootObj = $('.video-modal').clone(true);	
//						$(rootObj).removeClass('video-modal');
