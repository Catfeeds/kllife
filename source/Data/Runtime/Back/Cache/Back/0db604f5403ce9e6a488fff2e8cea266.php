						...
						<div class="col-md-11">
							...
							<div class="row user_info">
								<div class="data_account">
									...
									<span><?php echo ($admin["account"]); ?></span>
								</div>
								...
								<div class="data_type">
									...
									<span><?php echo ($admin["type_id_data"]["type_desc"]); ?></span>
								</div>
								<div class="data_station">
									<label for="" class="control-label">所属站点:</label>
									<span><?php echo ($admin["station_id_data"]["name"]); ?></span>
								</div>
								<div class="data_grant_group">
									<label for="" class="control-label">权限类型:</label>
									<span><?php echo ($admin["group_id_data"]["type_desc"]); ?></span>
								</div>
...
<script type="text/javascript">
	...
	function modifyPassword(){
		...
		$.post('<?php echo U("settle/modifypassword");?>', 
	...
	function modifyAdminInfo(){
		...
		var aid = '<?php echo ($admin["id"]); ?>';
		$.post('<?php echo U("admin/info");?>', 
			{
				op_type: 'edit',
				cd: {id: aid},
				data: [
