		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-4 data_fprice_price">
					...
					<div class="col-md-4 data_fprice_real_price">
...
<div class="price template_price hidden_ctrl" data-id="">
	<div class="row">
		...
		<div class="col-md-3 data_price_price">
			<label>报价：</label>
			<span></span>
		</div>
		<div class="col-md-3 data_price_real_price">
			<label>实价：</label>
			<span></span>
		</div>		
		<div class="col-md-3 data_price_review">
			<label>审核状态：</label>
			<span></span>
		</div>
	</div>
...
<!--详细内容，消费项，价格详细-->
<div class="price-container template_price_container hidden_ctrl">
	<div style="background-color: rgba(241,135,29,0.5);">
...
<script type="text/javascript">
	function ModalCJPrice(vobj, objType, objId, itemId) {
		...
		this.root = $('.template_price_container').clone();
...
<!--详细内容，价格项，价格详细-->
<div class="item-container template-item_container hidden_ctrl">
	<div style="background-color: rgba(96,163,35,0.5);">
...
<script type="text/javascript">
	...
	function ModalCJItem(vobj, objType, objId) {
		...
		this.root = $('.template-item_container').clone();
						...
						<ul>							
							<li <?php echo stripos(C('MENU_CURRENT'), 'financial_team') === false ? '' : 'class="active opened"';?>>
								...
								<ul>
									...
									<li <?php echo stripos(C('MENU_CURRENT'), 'financial_team_deposit') === false ? '' : 'class="active"';?>>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"> 
						...
						<input id="admin_id" type="hidden" value="<?php echo ($admin123["id"]); ?>"/>
					</h3>
				</div>
					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="row dingdan_bottom">
								...
								<span id="id_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["id"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">管理员账户：</p>
								<span id="account_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["account"]); ?></span>
								<input type="text" id="account_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_admin == true): ?><input type="button" name="account" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="account" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">管理员昵称：</p>
								<span id="nickname_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["nickname"]); ?></span>
							...
							<div class="row dingdan_bottom">
								...
								<span id="tel_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["tel"]); ?></span>
								<input type="text" id="tel_val" maxlength="11" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_admin == true): ?><input type="button" name="tel" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
							...
							<div class="row dingdan_bottom">
								...
								<span id="email_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["email"]); ?></span>
								<input type="text" id="email_val" style="height: 32px;" class="dingdan_bianji col-sm-3">
								<?php if($grant_update_admin == true): ?><input type="button" name="email" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
									<input type="button" name="email" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">管理员所属站点：</p>
								<span id="station_id_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($admin123["station_id_name"]); ?></span>
								<?php if($admin["account"] == 'admin'): ?><div id="station_id_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
										<script type="text/javascript">
											jQuery(document).ready(function($)
											{
										...
										<select id="station_id_val" class="form-control">
											<?php if(is_array($adminStation)): $i = 0; $__LIST__ = $adminStation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$station): $mod = ($i % 2 );++$i;?><option value="<?php echo ($station["id"]); ?>"><?php echo ($station["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									<?php if($grant_update_admin == true): ?><input type="button" name="station_id" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
										<input type="button" name="station_id" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; endif; ?>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">管理员类型：</p>
								<span id="type_id_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($admin123["type_id_type_desc"]); ?></span>
								<?php if($admin["account"] == 'admin'): ?><div id="type_id_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
										<script type="text/javascript">
											jQuery(document).ready(function($)
											{
										...
										<select id="type_id_val" class="form-control">
											<?php if(is_array($adminType)): $i = 0; $__LIST__ = $adminType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type["id"]); ?>"><?php echo ($type["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									<?php if($grant_update_admin == true): ?><input type="button" name="type_id" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
										<input type="button" name="type_id" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; endif; ?>
							</div>
							
							<?php if($admin["account"] == 'admin'): ?><div class="row dingdan_bottom">
									<p class="col-sm-1">管理员权限组：</p>
									<span id="group_id_show" class="col-sm-3" style="padding-left: 0; float: left;"><?php echo ($admin123["group_id_type_desc"]); ?></span>
									<div id="group_id_container" class="input-group col-sm-3 dingdan_bianji" style="border-color: #40bbea; float: left;">
										...
										<select id="group_id_val" class="form-control">
											<?php if(is_array($adminGroup)): $i = 0; $__LIST__ = $adminGroup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><option value="<?php echo ($group["id"]); ?>"><?php echo ($group["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									<?php if($grant_update_admin == true): ?><input type="button" name="group_id" class="btn btn-info btn_edit" style="vertical-align: middle;" value="编辑">
										<input type="button" name="group_id" class="btn btn-info btn_cancel" style="vertical-align: middle;" value="取消"><?php endif; ?>
								</div><?php endif; ?>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">禁用状态：</p>
								<span id="forbiden_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["forbidden_show_text"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">创建时间：</p>
								<span id="create_time_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["create_time"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">最后登录时间：</p>
								<span id="login_time_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["last_login_time"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">最后登录IP：</p>
								<span id="login_ip_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["last_login_ip"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">当前登录时间：</p>
								<span id="login_time_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["login_time"]); ?></span>
							</div>
							
							<div class="row dingdan_bottom">
								<p class="col-sm-1">当前登录IP：</p>
								<span id="login_ip_show" class="col-sm-3" style="padding-left: 0;"><?php echo ($admin123["login_ip"]); ?></span>
							</div>
								...
								<div class="row">
									<table id="table_message" class="table text-left" style="width: 80%;">
										<thead>
											...
											<tbody>
												<?php if(is_array($adminLog)): $i = 0; $__LIST__ = $adminLog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><tr>
														<td><span><?php echo ($log["create_time"]); ?></span></td>
														<td><span><?php echo ($log["content"]); ?></span></td>
...
<script type="text/javascript">
	...
	function saveData() {
		...
		$.post('<?php echo U("admin/info");?>', jsonData, function(data){
			if (data.result.errno != 0) {
				alert(data.result.message);
			} else {				
