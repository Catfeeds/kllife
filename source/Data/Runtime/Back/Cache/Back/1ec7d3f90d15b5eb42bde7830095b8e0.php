	...
	function initDataTable() {	
		var vTable = $("#example-1").dataTable({
			...
			"aoColumns": [
				...
				{"mData": "member_id.show_text", "aTargets": [3], "fnCreatedCell": replaceContent},
				{"mData": "create_time", "aTargets": [4]},
				{"mData": "update_time", "aTargets": [5]},
...
//					console.log(data.sql1 + ">>>>>" +　data.sql2);
	...
	function replaceContent(nTd, sData, oData, iRow, iCol) {
		if (iCol == 0) {
			...
			$(nTd).html(oData.member_id_name_show);
		}
	}
...
//		alert(JSON.stringify(oData['review_complate']));
	...
	function _editFun(aid, bComplate) {
		$.getJSON("<?php echo U('review/exitTeam');?>", {op:'review_response', id:aid, complate: bComplate}, function(data){
