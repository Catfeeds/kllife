...
//						});
	...
	<div class="article-list">
		<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i; if(empty($art['face_image']) == true): ?><div class="article-information-word" data-id="<?php echo ($art["id"]); ?>">
					<a href="<?php echo U('line/article');?>/type/create/id/<?php echo ($art["id"]); ?>" target="_blank"></a>
					<div class="article-information-word-div">
						<h3><?php echo ($art["title"]); ?></h3>
						<p><?php echo ($art["send_word"]); ?></p>
						<h6><?php echo ($art["create_time"]); ?></h6>
					</div>
			...
			<?php else: ?>
				<div class="article-information-img" data-id="<?php echo ($art["id"]); ?>">
					<a href="<?php echo U('line/article');?>/type/create/id/<?php echo ($art["id"]); ?>" target="_blank"></a>
					...
					<div class="article-operate" data-id="<?php echo ($art["id"]); ?>">
						<i class="article-preview">预览</i><i class="article-delete">删除</i>
					</div>
	...
	<div class="footer">						
		<a href="<?php echo U('line/article');?>/type/create" class="btn btn-secondary">创建文章</a>		
	</div>
	<!--面板内容结束-->
	...
	//加载更多
				...
				if (data.result.errno == 0) {
					if (typeof(data.ds) != 'undefined' && data.ds != null) {
						...
						for (var i=0; i<data.ds.length; i++) {
							...
							vhtml +='	<a href="'+'<?php echo U("line/article");?>/type/create/id/'+d.id+'" target="_blank"></a>';
							if (include_image == true) {
								vhtml +='	<div class="article-information-img-left">'+
										'		<img src="'+d.face_image+'" alt="">'+
										'	</div>';
		...
		function articleShow() {
			...
			var jumpUrl = '<?php echo U("line/article");?>/type/show/id/'+$(rootObj).attr('data-id');
			window.open(jumpUrl);
		}
