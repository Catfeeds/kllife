	...
	<div class="row">
		<div class="panel panel-color panel-info panel-content-pos">
			<div class="panel panel-heading">
				<span class="description"><?php echo C(CONTENT_TITLE);?>&nbsp;>&nbsp;<?php echo ($group["type_desc"]); ?></span>					
			</div>
			<div class="panel panel-color panel-content">
				<div class="row">
					<div class="col-md-1"></div>					
					<div class="col-md-10">
						<?php if(is_array($grants)): $i = 0; $__LIST__ = $grants;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><label>
								<input type="checkbox" class="iswitch iswitch-secondary" value="<?php echo ($g["id"]); ?>" <?php echo ($g["checked"]); ?>/>&nbsp;&nbsp;<?php echo ($g["grant_desc"]); ?>
							</label>
