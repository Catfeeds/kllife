								...
								<div class="col-sm-3">
									<div class="input-group">
										...
										<select class="form-control" name="" id="op_admin_type">
											<option value="-1">不限</option>
											<?php if(!empty($acctTypes)): if(is_array($acctTypes)): $i = 0; $__LIST__ = $acctTypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$acct): $mod = ($i % 2 );++$i;?><option value="<?php echo ($acct["type_key"]); ?>"><?php echo ($acct["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group">
										...
										<select class="form-control" name="" id="op_type">
											<option value="-1">不限</option>
											<?php if(!empty($opType)): if(is_array($opType)): $i = 0; $__LIST__ = $opType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type["id"]); ?>"><?php echo ($type["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="col-sm-3">
									<div class="input-group">
										...
										<select class="form-control" name="" id="op_table">
											<option value="-1">不限</option>
											<?php if(!empty($tabs)): if(is_array($tabs)): $i = 0; $__LIST__ = $tabs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i;?><option value="<?php echo ($tab["table_name"]); ?>"><?php echo ($tab["table_name"]); echo ($tab["table_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
										</select>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function initDataTable() {	
		var vTable = $(".aspTable").dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo U('settle/loglist');?>",
...
//		alert(nTd+'|'+JSON.stringify(sData)+'|'+JSON.stringify(oData)+'|'+iRow+'|'+iCol);
	...
	*/
	function _deleteFun(oData) {
		...
		$.post('<?php echo U("settle/loglist");?>',
