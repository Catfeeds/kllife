	...
	<style>
		...
		<div class="row">
			<div class="panel panel-color panel-info panel-content-pos">
				<div class="panel panel-heading">
					<span class="description"><?php echo C(CONTENT_TITLE);?></span>					
				</div>
				...
				<!--编辑内容至此开始-->
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<div class="input-group col-sm-10"> 
							...
							<input type="text" id="askfor_link" class="form-control no-left-border no-right-border form-focus-warning" value="<?php echo ($pcset["askfor_link"]); ?>"> 
							<span class="input-group-btn"> 
						...
						<div class="input-group col-sm-10"> 
							...
							<input type="text" id="team_link" class="form-control no-left-border no-right-border form-focus-warning" value="<?php echo ($pcset["team_link"]); ?>"> 
							<span class="input-group-btn"> 
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<?php if(is_array($pcset)): $i = 0; $__LIST__ = $pcset;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$set_val): $mod = ($i % 2 );++$i; if(stripos($key, 'pc_friend_link') === 0): $fk = json_decode($set_val,true); $fkid = $pcset['id_'.$key]; ?>
								<div class="input-group col-sm-10 friend_link" data-id="<?php echo ($fkid); ?>" data-base="pc" data-index="<?php echo ($fk["index"]); ?>"> 
									<span class="input-group-btn"> 
										<button class="btn btn-gray" type="button">链接：</button> 
									</span> 
									<input type="text" class="form-control no-left-border form-focus-warning friend_link_url" value="<?php echo ($fk["url"]); ?>">
									<span class="input-group-btn">  							
										<input type="text" class="form-control no-right-border form-focus-warning friend_link_text" value="<?php echo ($fk["text"]); ?>" style="width: 300px;"> 
										<button class="btn btn-secondary btn_set_friend_link" data-set="<?php echo ($key); ?>" type="button">设置</button> 
										<button class="btn btn-danger btn_del_friend_link" data-set="<?php echo ($key); ?>" type="button" style="border-left: 2px solid #fff;">删除</button> 
									</span>
								</div>
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<?php if(is_array($pcset)): $i = 0; $__LIST__ = $pcset;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$set_val): $mod = ($i % 2 );++$i; if(stripos($key, 'qlp_friend_link') === 0): $fk = json_decode($set_val,true); $fkid = $pcset['id_'.$key]; ?>
								<div class="input-group col-sm-10 friend_link" data-id="<?php echo ($fkid); ?>" data-base="qlp" data-index="<?php echo ($fk["index"]); ?>"> 
									<span class="input-group-btn"> 
										<button class="btn btn-gray" type="button">链接：</button> 
									</span> 
									<input type="text" class="form-control no-left-border form-focus-warning friend_link_url" value="<?php echo ($fk["url"]); ?>">
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<?php if(is_array($pcset)): $i = 0; $__LIST__ = $pcset;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$set_val): $mod = ($i % 2 );++$i; if(stripos($key, 'top_link_friend_link') === 0): $tk = json_decode($set_val,true); $tkid = $pcset['id_'.$key]; ?>
								<div class="input-group col-sm-10 friend_link" data-id="<?php echo ($tkid); ?>" data-base="top_link" data-index="<?php echo ($tk["index"]); ?>"> 
									<span class="input-group-btn"> 
										<button class="btn btn-gray" type="button">链接：</button> 
									</span> 
									<input type="text" class="form-control no-left-border form-focus-warning friend_link_url" value="<?php echo ($tk["url"]); ?>">
									<span class="input-group-btn">  							
										<input type="text" class="form-control no-right-border form-focus-warning friend_link_text" value="<?php echo ($tk["text"]); ?>" style="width: 300px;"> 
										<button class="btn btn-secondary btn_set_friend_link" data-set="<?php echo ($key); ?>" type="button">设置</button> 
										<button class="btn btn-danger btn_del_friend_link" data-set="<?php echo ($key); ?>" type="button" style="border-left: 2px solid #fff;">删除</button> 
									</span>
								</div>
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<div class="input-group col-sm-10"> 
							...
							<input type="text" id="askfor_tel" class="form-control no-left-border no-right-border form-focus-warning" value="<?php echo ($pcset["askfor_tel"]); ?>"> 
							<span class="input-group-btn"> 
					...
					<div class="col-sm-11" style="margin-left: 5%; margin-top: 3%;">
						...
						<div class="input-group col-sm-10">
							<textarea id="statistic_script" class="form-control" style="height: 200px;"><?php echo ($pcset["statistic_script"]); ?></textarea>
		...
		<script type="text/javascript">
			...
			$('.update_cache_all').click(function(){
				...
				$('<?php echo U("settle/settle");?>', {op_type: ''}, function(data){
					if (data.result.errno == 0) {
