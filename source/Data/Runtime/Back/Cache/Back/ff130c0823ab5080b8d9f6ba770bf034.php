	...
	<div class="row">
		<div class="panel panel-color panel-info panel-content-pos">
			...
			<div class="panel panel-color panel-content">
                ...
                <br />
				<div class="row">
					<?php if($grant_create == true): ?><a href="#" class="btn btn-primary" id="btn_create_type">创建管理员</a><?php endif; ?>
				</div>
			</div>
		</div>		
	</div>
...
//    	alert('<?php echo ($grant_update); ?>');
    	var html = '';
    	if ('<?php echo ($grant_forbid); ?>' == true) {
    	...
    	if ('<?php echo ($grant_delete); ?>' == true && typeof(oData['show_delete_button']) == 'undefined') {
...
//		    	console.log(JSON.stringify(backData));
	...
	function _infoFun(aid) {
		$.post('<?php echo U("admin/info");?>', {op_type:'url', id:aid}, function(data){
