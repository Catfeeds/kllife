...
//						});
	...
	<div class="row">
		<div class="col-sm-12 content">
			===============================数据转化信息======================================<br />
			总页数：<?php echo ($page_count); ?>&nbsp;&nbsp;&nbsp;&nbsp;<input id="start" type="button" data-op="start" value="点击按钮开始转化数据"/><br />
			===============================数据转化开始======================================<br />
		</div>
		<div class="list-page"></div>
	</div>
	...
	<script src="/source/Static/home/js/page.js"></script>
	<script type="text/javascript">		
		var curPage = 0, maxPage = '<?php echo ($page_count); ?>';
		// 触发翻页时间
		function changePage(p) {
			// 同步处理
			$.ajax({
				url: '<?php echo U("index/sql");?>',
				type: 'POST',
				async: true,
				dataType: 'json',
				data: {page: p},
			...
			// 异步处理
//			$.post('<?php echo U("index/sql");?>', {page:p}, function(data){
//				$('.content').append('===============================第'+p+'页======================================<br />');
//				if (data.result != null) {
//					$('.content').append(data.result.message);
