...
<style>
	...
	<div class="row">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input class="form-control" maxlength="32" name="title" id="title" value="<?php echo ($subject["title"]); ?>" placeholder="请输入专题的标题">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label class="control-label" for="desc">专题描述</label> <!--data-validate="required"-->
						<input class="form-control" maxlength="16" name="desc" id="desc" value="<?php echo ($subject["desc"]); ?>" placeholder="请输入专题的标题">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input class="form-control" name="keywords" id="keywords" value="<?php echo ($subject["keywords"]); ?>" placeholder="请输入专题的关键字,多个关键字请用“，”隔开">
					</div>
				</div>		
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input class="form-control" name="seo_title" id="seo_title" value="<?php echo ($subject["seo_title"]); ?>" placeholder="请输入专题的标题">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input class="form-control" name="seo_keywords" id="seo_keywords" value="<?php echo ($subject["seo_keywords"]); ?>" placeholder="请输入专题的关键字,多个关键字请用“，”隔开">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input class="form-control" name="seo_desc" id="seo_desc" value="<?php echo ($subject["seo_desc"]); ?>" placeholder="请输入专题的标题">
					</div>
				</div>
			</div>
		...
		<div class="zt-top">
			<img data-set="subject_banner" data-col="banner" class="subject_banner" src="<?php echo ($subject["banner"]); ?>" />
		</div>
		<div id="content">
			
			<div class="zt-main" data-id="<?php echo ($subject["id"]); ?>">
				<h3>推荐专题标题：
					<input id="recomment_subject_title" type="text" data-set="recommend_subject_title" value="<?php echo ($subject["recommend_subject_title"]["text"]); ?>" />
				...
				<ul class="recommend_subject">
					...
					<?php $__FOR_START_609897421__=0;$__FOR_END_609897421__=4;for($i=$__FOR_START_609897421__;$i < $__FOR_END_609897421__;$i+=1){ $liClass = $i % 4 == 0 ? 'clear-margin' : ''; $rcm_sub = $subject['recomment_subject'.$i]; ?>
						<?php if($i == 0): ?><li class="clear-margin">
						<?php else: ?>
						<li><?php endif; ?>
							<a href="javascript:;">	
								<img class="big-img-choose" src="<?php echo ($rcm_sub["bk_image"]); ?>" alt="">
								
								<div class="zt-content">
								
									<div class="zt-img">
										
										<img class="small-img-choose" src="<?php echo ($rcm_sub["word_image"]); ?>" alt="">
									</div>
									...
									<div class="zt-text-write">
				                        ...
				                        <div class="zt-text-introduce-write">
				                            ...
				                            <p class="zt-text-title">主标题：<input type="text" value="<?php echo ($rcm_sub["title"]); ?>" /></p>

				                            <p class="zt-text-desc">描述：<textarea><?php echo ($rcm_sub["desc"]); ?></textarea></p>
											
											<p class="zt-text-href">链接：<input type="text" value="<?php echo ($rcm_sub["url"]); ?>"/></p>
											
											<button class="btn zt-text-btn" data-set="recomment_subject<?php echo ($i); ?>" data-index="<?php echo ($i); ?>">保存</button>
				                        </div>
			...
			<div class="zt-list main">				
				<ul class="tab-list">
					<?php if(is_array($subject["line_tab"])): $i = 0; $__LIST__ = $subject["line_tab"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i;?><li>
							<?php if($key == 0): ?><a href="javascript:;" class="g" data-set="<?php echo ($tab["type_key"]); ?>" data-id="<?php echo ($tab["id"]); ?>" data-key="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></a>
							<?php else: ?>
								<a href="javascript:;" data-set="<?php echo ($tab["type_key"]); ?>" data-id="<?php echo ($tab["id"]); ?>" data-key="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></a><?php endif; ?>
							<span>X</span>
				...
				<div class="zt-sublist">
					<?php if(is_array($subject["show_tab_line_data"])): $i = 0; $__LIST__ = $subject["show_tab_line_data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$line): $mod = ($i % 2 );++$i;?><div class="zt-sublist-content" data-id="<?php echo ($line["id"]); ?>">								
								<div class="zt-text-move">
									<button class="btn btn-secondary btn_line_move up">上移</button>
									<button class="btn btn-secondary btn_line_move down">下移</button>
								</div>
								...
								<div class="zt-sublist-describe">
									<h5><a href="javascript:;" target="_blank" class="title"><?php echo ($line["title"]); ?>(No.<?php echo ($line["id"]); ?>)</a></h5>
									<p class="zt-sublist-line">线路简介：<span class="send_word"><?php echo ($line["send_word"]); ?></span></p>
									<p>价格：<strong>成人：￥<em class="adult_price"><?php echo ($line["start_price_adult"]); ?></em></strong></p>
									<p>活动时间：<span><?php echo ($line["start_time"]); ?> 至 <?php echo ($line["end_time"]); ?></span></p>
			...
			<div class="wonderful-travels">
				...
				<ul>
					<?php $__FOR_START_1324150965__=0;$__FOR_END_1324150965__=8;for($i=$__FOR_START_1324150965__;$i < $__FOR_END_1324150965__;$i+=1){ $youji = $subject['youji'.$i]; ?>
						<li>
							<a href="javascript:;">
								<img class="bk_image" src="<?php echo ($youji["img"]); ?>"/>
								<div class="wonderful-describe-write">
									<p class="desc">描述：<input type="text" value="<?php echo ($youji["desc"]); ?>" /></p>
									<p class="url">链接：<input type="text" value="<?php echo ($youji["url"]); ?>"/></p>
									<p class="img_url">图片链接：<input type="text"/></p>
									<button class="btn btn-secondary use_img_url">使用</button>
									<button class="btn wonderful-btn-save" data-set="youji<?php echo ($i); ?>" data-index="<?php echo ($i); ?>">保存</button>
								</div>
							</a>
						</li><?php } ?>					
				</ul>
					...
					<div class="hot-sale-product set_root" id="hot_line_recommend" data-set="hot_line_recommend">
						<div class="hot-sale-product-small">
							...
							<a class="hot_line_recommend" href="javascript:;" data-index="0" data-set="hot_line_recommend0">
								...
								<div class="aaa" data-id="<?php echo ($subject['hot_line_recommend0']['id']); ?>">
									...
									<span><?php echo ($subject['hot_line_recommend0']['send_word']); ?></span>
									<p>￥<em><?php echo ($subject['hot_line_recommend0']['start_price_adult']); ?></em>起</p>
									<strong>查看详情></strong>
								</div>
							</a>
							<a class="hot_line_recommend" href="javascript:;" data-index="1" data-set="hot_line_recommend1">
								...
								<div data-id="<?php echo ($subject['hot_line_recommend1']['id']); ?>">
									...
									<span><?php echo ($subject['hot_line_recommend1']['send_word']); ?></span>
									<p>￥<em><?php echo ($subject['hot_line_recommend1']['start_price_adult']); ?></em>起</p>
									<strong>查看详情></strong>
								</div>
							</a>
						</div>
						<a href="javascript:;" class="hot-sale-big hot_line_recommend" data-index="2" data-set="hot_line_recommend2">
							...
							<div data-id="<?php echo ($subject['hot_line_recommend2']['id']); ?>">
								...
								<span><?php echo ($subject['hot_line_recommend2']['send_word']); ?></span>
								<p>￥<em><?php echo ($subject['hot_line_recommend2']['start_price_adult']); ?></em>起</p>
								<strong>查看详情></strong>
							</div>
						</a>
						<div class="hot-sale-product-small">
							<a class="hot_line_recommend" href="javascript:;" data-index="3" data-set="hot_line_recommend3">
								...
								<div data-id="<?php echo ($subject['hot_line_recommend3']['id']); ?>">
									...
									<span><?php echo ($subject['hot_line_recommend3']['send_word']); ?></span>
									<p>￥<em><?php echo ($subject['hot_line_recommend3']['start_price_adult']); ?></em>起</p>
									<strong>查看详情></strong>
								</div>
							</a>
							<a class="hot_line_recommend" href="javascript:;" data-index="4" data-set="hot_line_recommend4">
								...
								<div data-id="<?php echo ($subject['hot_line_recommend4']['id']); ?>">
									...
									<span><?php echo ($subject['hot_line_recommend4']['send_word']); ?></span>
									<p>￥<em><?php echo ($subject['hot_line_recommend4']['start_price_adult']); ?></em>起</p>
									<strong>查看详情></strong>
								</div>
							</a>
						</div>
	...
	<div class="zt-list-tab">
		<div class="zt-tab-modal-add">
			<p>添加标签：</p>
			<?php if(is_array($line_theme)): $i = 0; $__LIST__ = $line_theme;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$theme): $mod = ($i % 2 );++$i;?><a href="javascript:;" data-id="<?php echo ($theme["id"]); ?>" data-key="<?php echo ($theme["type_key"]); ?>"><?php echo ($theme["type_desc"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>			
		</div>
	...
	<script>
		// 初始化
		$(document).ready(function(){
			$('#recomment_subject_subheading').data('wysihtml5').editor.setValue('<?php echo ($subject["recommend_subject_subheading"]["text"]); ?>');
		});
		...
		$('.save_zhuanti').click(function(){
			...
			$.post('<?php echo U("line/subject");?>', jsonData, function(data){
				if (data.id != null) {
...
//			}							
		...
		// 初始化线路Tab页样式
		setTabStyle('<?php echo ($subject["line_tab_class"]["text"]); ?>');
