						...
						<div class="col-sm-3">
							...
							<div class="input-group">
								...
								<select class="form-control" name="" id="task_project">
									...
									<?php if(!empty($TaskProject)): if(is_array($TaskProject)): $i = 0; $__LIST__ = $TaskProject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($tp["id"]); ?>"><?php echo ($tp["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
