					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="row dingdan_bottom">
								...
								<input id='channel_order_sn' type="text" style="height: 32px;" class="dingdan_bianji col-sm-5">
							</div>
							...
							<!--<div class="row dingdan_bottom">
								...
								<div class="input-group lianxiren_card col-sm-3" style="height:33px; border-left: 1px solid #40bbea; float: left;">
									<span class="input-group-btn" style="display: inline-block; float: left; position: relative; z-index: 999;">
										<button type="button" class="btn btn-info dropdown-toggle ctr_card_btn" style="width:100px; float:left; margin-top: -7px;" data-toggle="dropdown" data-id="<?php echo ($certType[0]['id']); ?>">
							...
							<div class="row dingdan_bottom">
								<p class="col-sm-1">订单金额：</p>
								<input id="team_cut_price" type="number" style="height: 32px;" class="dingdan_bianji col-sm-3" value="0.00">
							</div>
...
//		console.log(JSON.stringify(jsonData));
	...
	function createOrder() {		
		...
		var jsonData = {
			...
			'hdid': $('#activity').val(),
			'channel_order_sn': $('#channel_order_sn').val(),
			...
			'new_line': 1,//$('.new_line').is(':checked') == false ? 0 : 1,
			'channel': 1,
			'team_cut_price': $('#team_cut_price').val(),
		}
