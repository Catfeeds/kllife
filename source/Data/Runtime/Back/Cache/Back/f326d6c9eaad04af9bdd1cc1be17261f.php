			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"> 
						...
						<input id="review_id" type="hidden" value="<?php echo ($deposit["id"]); ?>"/>
					</h3>
				</div>
				<div class="panel-body row">
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<?php if(empty($deposit['team_id']) == false): ?><div class="form-group row">
									<p class="col-sm-1">团期：</p>	
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["team_data"]["team_code"]); ?></span>						
								</div><?php endif; ?>
							<div class="form-group row">
								<p class="col-sm-1">对象类型：</p>	
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["deposit_obj_data"]["type_desc"]); ?></span>						
							</div>
							<div class="form-group row">
								<p class="col-sm-1">送审对象：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["deposit_obj_show"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">操作方式：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["deposit_type_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">提审金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["approval_amount"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">预算金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["money"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">优惠减免：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["derate"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">最终预算金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo bcsub($deposit['money'], $deposit['derate'], 2);?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">已交易金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["complated_money"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">提审人员：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["request_admin_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">提审时间：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["request_time"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">提审附言：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["beizhu"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款方式：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["pay_type_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款人：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["payee"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款账号：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["bank_card"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">开户地址：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["bank_address"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核状态：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["review_type_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核人信息：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["review_admin_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审批资金：</p>	
								<!--<?php if(empty($can_be_review)): endif; ?>-->
								<?php if(empty($can_be_review) == false and $admin['id'] === $deposit['review_admin_data']['id']): ?><input id='review_msg' type="number" style="height: 32px;" class="dingdan_bianji col-sm-8 data_review_money" value="<?php echo ($deposit["approval_amount"]); ?>">
								<?php else: ?>									
									<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["finnal_money"]); ?></span><?php endif; ?>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核时间：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["review_time"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核附言：</p>		
								<?php if(empty($can_be_review) == false and $admin['id'] === $deposit['review_admin_data']['id']): ?><input id='review_msg' type="text" style="height: 32px;" class="dingdan_bianji col-sm-8 data_review_beizhu">
								<?php else: ?>
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["review_beizhu"]); ?></span><?php endif; ?>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">确认人信息：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["confirm_admin_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">确认资金：</p>
								<?php if(empty($can_be_commit)): ?><span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($deposit["confirm_money"]); ?></span>
								<?php else: ?>
									<input id='review_msg' type="number" style="height: 32px;" class="dingdan_bianji col-sm-8 data_confirm_money" value="<?php echo ($deposit["finnal_money"]); ?>"><?php endif; ?>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">确认时间：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["confirm_time"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">确认附言：</p>
								<?php if(empty($can_be_commit)): ?><span class="col-sm-5" style="padding-left: 0;"><?php echo ($deposit["confirm_beizhu"]); ?></span>
								<?php else: ?>
									<input id='review_msg' type="text" style="height: 32px;" class="dingdan_bianji col-sm-8 data_confirm_beizhu"><?php endif; ?>						
							</div>					
							<div class="form-group row">
								<?php if(empty($can_be_review) == false and $admin['id'] === $deposit['review_admin_data']['id']): ?><button id="review_pass" type="button" class="btn btn-warning" style="margin-left: 1%;">通过审核</button>
									<button id="review_fail" type="button" class="btn btn-warning" style="margin-left: 1%;">回绝审核</button><?php endif; ?>
								<?php if(empty($can_be_commit) == false): ?><button id="review_confirm" type="button" class="btn btn-warning" style="margin-left: 1%;">确认提审</button>
									<button id="review_confirm_fail" type="button" class="btn btn-warning" style="margin-left: 1%;">拒绝确认</button><?php endif; ?>
								<?php if(empty($deposit['team_id']) == false): ?><a id="team_info" href="<?php echo U('financial/team');?>/op/new/id/<?php echo ($deposit["team_id"]); ?>" class="btn btn-secondary" style="margin-left: 1%;" target="_blank">查看团期</a>
								<?php else: ?>
									<a id="team_info" href="<?php echo U('financial/deposit');?>/op/new/id/<?php echo ($deposit["id"]); ?>" class="btn btn-secondary" style="margin-left: 1%;" target="_blank">查看详细</a><?php endif; ?>
								<a id="back_list" href="<?php echo U('financial/deposit');?>" class="btn btn-secondary" style="margin-left: 1%;" target="_blank">返回列表</a>
							</div>
						</div>
					</div>
					...
					<div id="dingdan_log" class="col-sm-11" style="margin-left: 5%;">	
						...
						<table class="table table1 table_supervise">
							...
							<tbody>
								<!--<?php echo p_a($deposit['supervises']);?>-->
								<?php if(is_array($deposit["supervises"])): $i = 0; $__LIST__ = $deposit["supervises"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($s["id"]); ?>">
										<td><?php echo ($s["id"]); ?></td>
										<td><?php echo ($s["admin"]["show_name"]); ?></td>
...
<script type="text/javascript">
	...
	$('.source-info-float').click(function(){
		...
		fReviewModalObj.showModal(this, '<?php echo ($deposit["team_id"]); ?>', null, '<?php echo ($deposit["id"]); ?>', null, 1);
	});
	...
	function updateReview(opstate, vmoney, vbeizhu) {
		...
		$.post('<?php echo U("financial/deposit");?>', jsonData, function(data){
			...
			if (data.result.errno == 0) {
				...
				location.href = '<?php echo U("financial/deposit");?>/id/'+reviewId;
			} else {
				toastr.error(data.result.message);
			}
		});
