					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["lineid_title"]); ?></span>						
							</div>
							<div class="form-group row">
								<p class="col-sm-1">线路批次：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["hdid_show_text"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">订单编号：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["order_sn"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">订单状态：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_state_id_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">用户名：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["userid_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">联系人：</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["names"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">联系人电话</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["order_id_data"]["mob"]); ?></span>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<p class="col-sm-1">退团人姓名：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["member_id_name_show"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">退团人电话：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["member_id_phone_show"]); ?></span>
							</div>
							<?php if(!empty($review_complate)): ?><div class="form-group row">
									<p class="col-sm-1">审批人：</p>
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["review_admin_id_data"]["show_name"]); ?></span>
								</div><?php endif; ?>
							<div class="form-group row">
							...
							<div class="form-group row">
								<?php if(empty($review_complate)): ?><button id="review_pass" type="button" class="btn btn-warning" style="margin-left: 1%;">通过审核</button>
							...
							<div class="form-group row">
								<p class="col-sm-12"><?php echo ($change_member_result["message"]); ?></p>
								<p class="col-sm-12"><?php echo ($exit_member_result["message"]); ?></p>
							</div>
						</div>
					</div>
				</div>
...
//		console.log(JSON.stringify(jsonData));		
		showLoading(true);
		$.post('<?php echo U("review/exitTeam");?>', jsonData, function(data){
			showLoading(false);
			if (data.result.errno == 0) {
				alert('订单审核操作成功');
				location.href = '<?php echo U("review/exitTeam");?>';
			} else {
				alert(data.result.message);
