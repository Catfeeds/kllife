                    ...
                    <table id="test" class="table aspTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="10%">权限值</th>
                                <th width="20%">
                                	<?php if(is_array($adminType)): $i = 0; $__LIST__ = $adminType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adType): $mod = ($i % 2 );++$i; echo ($adType["type_desc"]); ?>/<?php endforeach; endif; else: echo "" ;endif; ?>
                                </th>
								<?php if(($grant_update == true) OR ($grant_delete == true)): ?><th width="15%" class="TAC">编辑/删除</th><?php endif; ?>
                            </tr>
                        </thead>
                    </table>   
                    
					<div class="row">
						<?php if($grant_create == true): ?><div class="col-md-1">
								<a href="#" class="btn btn-primary" style="float: right" id="btn_create_type">创建类型</a>
							</div><?php endif; ?>
						<?php if($grant_delete == true): ?><div class="col-md-11">
...
//    	
	...
	*/
	function _addFun() {
		location.href = '<?php echo U("grant/list", "op=show_create");?>';
	}
	...
	*/
	...
	function _editFun(aid) {
		$.getJSON('<?php echo U("grant/list");?>', {op:'show_edit', id:aid}, function(data){
