				...
				<div class="panel-body">
					...
					<table class="table table1 table_order">
						...
						<tbody id="taocan-list">
							<?php if(is_array($taocans)): $i = 0; $__LIST__ = $taocans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tp): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($tp["id"]); ?>">
									<td><?php echo ($tp["id"]); ?></td>
									<td><?php echo ($tp["name"]); ?></td>
									<td><?php echo ($tp["type_data"]["type_desc"]); ?></td>
									<td><?php echo ($tp["desc"]); ?></td>
									<td>
										<button class="btn btn-secondary edit-taocan" data-id="<?php echo ($tp["id"]); ?>" type="button">编辑</button>
										<button class="btn btn-danger remove-taocan" data-id="<?php echo ($tp["id"]); ?>" type="button">删除</button>
									</td>
