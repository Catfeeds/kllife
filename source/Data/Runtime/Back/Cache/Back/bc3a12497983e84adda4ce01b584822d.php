							...
							<div class="row form-group">
								...
								<div class="input-group col-sm-3" style="border-color: #40bbea;">
									...
									<select id="team_result" class="form-control">
										<?php if(is_array($teamResult)): $i = 0; $__LIST__ = $teamResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><option value="<?php echo ($result["id"]); ?>"><?php echo ($result["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="input-group col-sm-3" style="border-color: #40bbea;">
									...
									<select id="hotel_request" class="form-control">
										<?php if(is_array($hotelRequest)): $i = 0; $__LIST__ = $hotelRequest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotel): $mod = ($i % 2 );++$i;?><option value="<?php echo ($hotel["id"]); ?>"><?php echo ($hotel["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="input-group col-sm-3" style="border-color: #40bbea;">
									...
									<select id="leader_request" class="form-control">
										<?php if(is_array($leaderRequest)): $i = 0; $__LIST__ = $leaderRequest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leader): $mod = ($i % 2 );++$i;?><option value="<?php echo ($leader["id"]); ?>"><?php echo ($leader["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
...
//											    console.log(selectBoxIt.option("showFirstOption"));
									...
									<select id="car_request" class="form-control">
										<?php if(is_array($carRequest)): $i = 0; $__LIST__ = $carRequest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$car): $mod = ($i % 2 );++$i;?><option value="<?php echo ($car["id"]); ?>"><?php echo ($car["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>-->
							...
							<div class="row form-group">
								...
								<div class="input-group col-sm-3" style="border-color: #40bbea;">
									...
									<select id="especial_request" class="form-control">
										<?php if(is_array($especialRequest)): $i = 0; $__LIST__ = $especialRequest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$especial): $mod = ($i % 2 );++$i;?><option value="<?php echo ($especial["id"]); ?>"><?php echo ($especial["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="input-group col-sm-3" style="border-color: #40bbea;">
									...
									<select id="contact_request" class="form-control">
										<?php if(is_array($contactRequest)): $i = 0; $__LIST__ = $contactRequest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contact): $mod = ($i % 2 );++$i;?><option value="<?php echo ($contact["id"]); ?>"><?php echo ($contact["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
							<div class="form-group row">
...
//		console.log(JSON.stringify(jsonData));
		...
		showLoading(true)
		$.post('<?php echo U("team/create");?>', jsonData, function(data){
//			console.log(JSON.stringify(jsonData));
			if (data.result.errno == 0) {
				alert(data.result.message);
				location.href = '<?php echo U("team/list");?>';
			} else {
