			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"> 
						...
						<input id="review_id" type="hidden" value="<?php echo ($review["id"]); ?>"/>
					</h3>
				</div>
					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($order["order_sn"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">渠道订单编号</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($order["channel_order_sn"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">用户名</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($order["userid_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">联系人</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($order["names"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">联系人电话</p>								
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($order["mob"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">原订单状态：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["order_state_id_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">订单状态：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($order["zhuangtai_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">订单总金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($order["need_pay_money"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">订单已付金额：</p>								
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($order["pay_cash"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">费用用途：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["cash_use_id_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核类型：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["review_type_id_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">费用功能：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["cash_func_id_data"]["type_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">审核费用：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["cash"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款类型：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["pay_type_id_data"]["item_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款渠道：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["pay_channel_id_data"]["item_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">收款方：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["pay_bank_id_data"]["item_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">回执编号：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["bank_code"]); ?></span>
							</div>		
							<div class="form-group row">
								<p class="col-sm-1">申请人：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["admin_id_data"]["show_name"]); ?></span>
							</div>
							<?php if(!empty($review_complate)): ?><div class="form-group row">
									<p class="col-sm-1">审批人：</p>
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["review_admin_id_account"]); ?></span>
								</div><?php endif; ?>
							<div class="form-group row">
								<p class="col-sm-1">申请时间：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["create_time"]); ?></span>
							</div>
							<?php if(!empty($review_complate)): ?><div class="form-group row">
									<p class="col-sm-1">审批时间：</p>
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["update_time"]); ?></span>
								</div><?php endif; ?>
							<div class="form-group row">
								<p class="col-sm-1">请求附言：</p>
								<span class="col-sm-8" style="padding-left: 0;"><?php echo ($review["request_reason"]); ?></span>
							</div>
							<?php if($review_complate): ?><div class="form-group row">
									<p class="col-sm-1">审核附言：</p>
									<span class="col-sm-8" style="padding-left: 0;"><?php echo ($review["response_reason"]); ?></span>
								</div>
							<?php else: ?>
								<div class="form-group row">
									<p class="col-sm-1">审核附言：</p>
							...
							<div class="form-group row">
								<?php if(empty($review_complate)): if($grant_response_review == true): ?><button id="review_pass" type="button" class="btn btn-warning" style="margin-left: 1%;">通过审核</button>
										<button id="review_fail" type="button" class="btn btn-warning" style="margin-left: 1%;">回绝审核</button><?php endif; endif; ?>
								<button id="back_order_info" type="button" class="btn btn-secondary" style="margin-left: 1%;">订单详细</button>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		// 返回订单详细
		$('#back_order_info').click(function(){
			var orderId = '<?php echo ($review["order_id"]); ?>';
				$.getJSON("<?php echo U('order/info');?>", {op:'order_info', id:orderId}, function(data){
	...
	function updateReview(bPass) {
		...
		var old_state = '<?php echo ($order["zhuangtai"]); ?>';
		var new_state = '<?php echo ($review["order_state_id"]); ?>';
		if (old_state == new_state) {
			if (!confirm('订单的状态未改变，您是否确定要进行此操作?')) {
				return false;
			}
		}
