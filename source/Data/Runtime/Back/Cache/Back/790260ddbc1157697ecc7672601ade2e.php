									...
									<div class="col-sm-3">
										<div class="input-group">
											...
											<select class="selector-control" id="item_type">
												<option value="-1">不限</option>
												<?php if(!empty($MenuItemTypes)): if(is_array($MenuItemTypes)): $i = 0; $__LIST__ = $MenuItemTypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mit): $mod = ($i % 2 );++$i;?><option value="<?php echo ($mit["id"]); ?>"><?php echo ($mit["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
											</select>
										</div>
									</div>	
                    ...
                    <table id="test" class="table aspTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="5%">排序</th>
                                <?php if($grant_create_menu == true or $grant_update_menu == true or $grant_delete_menu == true): ?><th width="25%" class="TAC">添加/编辑/禁用/删除</th><?php endif; ?>
                            </tr>
                        </thead>
                    </table>   
                    
                    <?php if($grant_create_menu == true): ?><div class="row">
							<div class="col-md-1">
...
<script type="text/javascript">
	...
	function dataTablesBindCols() {
		...
		var idx = cols.length;
		if ('<?php echo ($grant_create_menu); ?>' == true || '<?php echo ($grant_update_menu); ?>' == true || '<?php echo ($grant_delete_menu); ?>' == true) {
