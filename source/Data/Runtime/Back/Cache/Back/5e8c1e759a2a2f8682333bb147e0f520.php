					...
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["user_id_data"]["show_name"]); ?></span>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["pay_channel_id_data"]["item_desc"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">提款账户：</p>
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["pay_account"]); ?></span>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["take_time"]); ?></span>
							</div>
							<?php if(!empty($review_complate)): ?><div class="form-group row">
									<p class="col-sm-1">审批时间：</p>
									<span class="col-sm-5" style="padding-left: 0;"><?php echo ($review["review_time"]); ?></span>
								</div><?php endif; ?>
							<?php if($review_complate): ?><div class="form-group row">
									<p class="col-sm-1">审核附言：</p>
									<span class="col-sm-8" style="padding-left: 0;"><?php echo ($review["beizhu"]); ?></span>
								</div>
							<?php else: ?>
								<div class="form-group row">
									<p class="col-sm-1">审核附言：</p>
							...
							<div class="form-group row">
								<?php if(empty($review_complate)): if($grant_review == true): ?><button id="review_pass" type="button" class="btn btn-warning" style="margin-left: 1%;">通过审核</button>
...
//		console.log(JSON.stringify(jsonData));
		showLoading(true);
		$.post('<?php echo U("review/takecash");?>', jsonData, function(data){
			showLoading(false);
			if (data.result.errno == 0) {
				alert('提款审核操作成功');
				location.href = '<?php echo U("review/takecash");?>';
			} else {
				alert(data.result.message);
