	...
	<script>
		...
		function showLoading(bshow, tips) {
			if (bshow == false) {
				...
				var centerX = $(window).width() / 2, centerY = $(document).height() / 2;
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default" id="xingcheng">
				...
				<div class="row all-main" style="margin-left: 5%;">
					<?php if(empty($scheduling)): ?><span>没有行程可供查看</span><br /><br /><?php endif; ?>
					<?php if(is_array($scheduling)): $i = 0; $__LIST__ = $scheduling;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sc): $mod = ($i % 2 );++$i;?><div class="col-12 xingcheng-main">
							<input type="hidden" name="scheduling_id" value="<?php echo ($sc["id"]); ?>" />
							<div class="xingcheng-nav">
								<h5 class="xingcheng-day"><?php echo ($sc["day_num"]); ?></h5>
								<div>
									<p class="xingcheng-numday"><?php echo ($sc["day_char"]); ?></p>
									<div>
										<p class="col-sm-3 xingcheng-place"><?php echo ($sc["destination"]); ?></p>
										<input type="text" name="destination" class="dingdan_bianji bj-place">
										<?php if($grant_update_scheduling == true): ?><input type="button" class="btn btn-info tab-place dingdan_btn_bianji" value="编辑">
											<input type="button" class="btn btn-info tab-place dingdan_btn_cancel" value="取消"><?php endif; ?>
									</div>
								</div>
							</div>
							<div class="xingcheng-content">
								<div class="xingcheng-border">
									...
									<div>
										<p class="col-sm-3 xingcheng02"><?php echo ($sc["traffic_tool"]); ?></p>
										<input type="text" name="traffic_tool" class="dingdan_bianji bj-traffic">
										<?php if($grant_update_scheduling == true): ?><input type="button" class="btn btn-info tab-traffic dingdan_btn_bianji" value="编辑">
											<input type="button" class="btn btn-info tab-traffic dingdan_btn_cancel" value="取消"><?php endif; ?>
									</div>
								</div>
								<div class="xingcheng-border">
									<p class="xingcheng01">入住酒店</p>
									<div>
										<p class="col-sm-3 xingcheng02"><?php echo ($sc["hotel"]); ?></p>
										<input type="text" name="hotel" class="dingdan_bianji bj-hotel">
										<?php if($grant_update_scheduling == true): ?><input type="button" class="btn btn-info tab-hotel dingdan_btn_bianji" value="编辑">
											<input type="button" class="btn btn-info tab-hotel dingdan_btn_cancel" value="取消"><?php endif; ?>
									</div>
								</div>
								<div class="xingcheng-border">
									<p class="xingcheng03">
										<span class="col-sm-2 text-left" style="padding-left: 0;">早餐：<em><?php echo ($sc["breakfast"]); ?></em><input maxlength="10" name="breakfast" class="dingdan_bianji" type="text"></span>
										<span class="col-sm-2 text-left">午餐：<em><?php echo ($sc["lunch"]); ?></em><input class="dingdan_bianji" name="lunch" type="text"></span>
										<span class="col-sm-2 text-left">晚餐：<em><?php echo ($sc["supper"]); ?></em><input class="dingdan_bianji" name="supper" type="text"></span>
										<?php if($grant_update_scheduling == true): ?><input class="btn btn-info dingdan_btn_bianji tab-food" type="button" style="vertical-align: inherit; margin: 0;" value="编辑">
											<input class="btn btn-info dingdan_btn_cancel tab-food" type="button" style="vertical-align: inherit; margin: 0;" value="取消"><?php endif; ?>
									</p>
								</div>
								<div class="xingcheng-border">
									<p class="xingcheng01">行程介绍</p>
									<div>
										<pre class="col-sm-8"><?php echo ($sc["intro"]); ?></pre>
										<textarea class="col-sm-8 dingdan_bianji" name="intro" style="resize: none; height: 500px; display: none;"></textarea>
										<?php if($grant_update_scheduling == true): ?><input class="tab-introduce btn btn-info dingdan_btn_bianji col-sm-1" type="button" value="编辑">
											<input class="tab-introduce btn btn-info dingdan_btn_cancel col-sm-1" type="button" value="取消"><?php endif; ?>
									</div>
								</div>
							</div>
							<?php if($grant_delete_scheduling == true): ?><div class="col-sm-12" style="overflow: hidden;">
					...
					<?php if($grant_create_scheduling == true): ?><button id="add-xingcheng" class="btn btn-info">添加行程</button><?php endif; ?>
...
<script type="text/javascript">
	...
	function createData() {
		...
		$.post('<?php echo U("team/scheduling");?>', {op:'create', tid:teamId}, function(data){
	...
	function saveData() {
		...
		$.post('<?php echo U("team/scheduling");?>', jsonData, function(data){
	...
	function deleteData() {
		...
		$.post('<?php echo U("team/scheduling");?>', {op: 'delete', id: schedulingId}, function(data){
