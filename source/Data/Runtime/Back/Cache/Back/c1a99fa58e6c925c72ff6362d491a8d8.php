				...
				<div class="panel-body row">
					<div id="dingdan_main" class="col-sm-12" style="margin-left: 5%;">
						<div class="row">
							...
							<div class="form-group row">
								<p class="col-sm-1">原男/女/小孩：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["old_male"]); ?>/<?php echo ($review["old_woman"]); ?>/<?php echo ($review["old_child"]); ?></span>
							</div>
							<div class="form-group row">
								<p class="col-sm-1">现男/女/小孩：</p>
								<span class="col-sm-5" style="padding-left: 0; color: red;"><?php echo ($review["male"]); ?>/<?php echo ($review["woman"]); ?>/<?php echo ($review["child"]); ?></span>
							</div>
...
//		console.log(JSON.stringify(jsonData));		
		showLoading(true);
		$.post('<?php echo U("review/changeCount");?>', jsonData, function(data){
			showLoading(false);
			if (data.result.errno == 0) {
				alert('订单审核操作成功');
				location.href = '<?php echo U("review/changeCount");?>';
			} else {
				alert(data.result.message);
