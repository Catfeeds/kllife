	...
	<div class="row">
		<div class="panel panel-color panel-info panel-content-pos">
			<div class="panel panel-heading">
				<?php if(empty($grant)): ?><span class="description">创建权限</span><?php endif; ?>
				<?php if(!empty($grant)): ?><span class="description">编辑权限&nbsp;>&nbsp;<?php echo ($grant["grant_desc"]); ?></span><?php endif; ?>
				<input id="grant_id" type="hidden" value="<?php echo ($grant["id"]); ?>"/>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-11">
						<div class="form-group col-xs-3">
							<input id="grant_key" class="form-control" value="<?php echo ($grant["grant_key"]); ?>" />
						</div>	
					</div>
					<div class="col-md-1">
					...
					<div class="col-md-11">		
						<div class="form-group col-xs-3">
							<input id="grant_value" class="form-control" value="<?php echo ($grant["grant_value"]); ?>" />
						</div>						
					</div>
					<div class="col-md-1">
					...
					<div class="col-md-11">
						<div class="form-group col-xs-3">
							<select id="grant_type">
								<?php if(is_array($grantType)): $i = 0; $__LIST__ = $grantType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gt): $mod = ($i % 2 );++$i;?><option value="<?php echo ($gt["id"]); ?>" <?php echo ($gt["selected"]); ?>><?php echo ($gt["type_desc"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>								
					</div>
					<div class="col-md-1">
					...
					<div class="col-md-11">
						<div class="form-group col-xs-8">
							<input id="grant_desc" class="form-control" value="<?php echo ($grant["grant_desc"]); ?>" />
						</div>								
					</div>
					<div class="col-md-12">
						<hr style="height:2px; width:100%; color:#eeeeee;"/>
						请选择可使用该权限的对象类型:<br><br>						
						<?php if(is_array($adminType)): $i = 0; $__LIST__ = $adminType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$at): $mod = ($i % 2 );++$i;?><label>
								<input type="checkbox" class="iswitch iswitch-secondary" value="<?php echo ($at["id"]); ?>" <?php echo ($at["checked"]); ?>/>&nbsp;&nbsp;<?php echo ($at["type_desc"]); ?>&nbsp;&nbsp;
							</label><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>       
				<br /><br /><br />
				<div class="row">
					<?php if($grant_save == true): ?><div class="col-md-1">
