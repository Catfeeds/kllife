					...
					<li <?php echo C('MENU_ACTIVE')=='statistics' ? 'class="active opened"' : '';?>>
						...
						<ul>
							...
							<li <?php echo C('MENU_CURRENT')=='statistics_day' ? 'class="active"' : '';?>>
								<a href="<?php echo U('statistics/day');?>"><span class="title">日报表</span></a>
							</li>
						</ul>
					</li>
...
<?php echo p_a($data);?>
<?php echo date('Y-m-d H:i:s', 1467331200);?><br />
<img src="<?php echo U('help/verify');?>/w/150/h/60/l/4/f/16" style="vertical-align: middle; cursor: pointer;"/>
<input type="text" id="test_val" value="114.247.50.2"/>
<input type="button" class="test_button" value="测试" />
<input type="radio" class="test_rd" name="type" value="0" checked />高德
<input type="radio" class="test_rd" name="type" value="1" />淘宝
<div class="msg"></div>
<script>
	$('img').click(function(){
//		$.getJSON(<?php echo U("help/verify");?>,'', function(data){			
//		});
		$(this).attr('src', '<?php echo U("help/verify");?>');
	});
	
	$('.test_button').click(function(data){
//		var jsonData = {
//			ip: $('#test_val').val(), 
//			type: $('.test_rd:checked').val(),
//		}

		var unixTime = DatetimeToUnixtime($('#test_val').val());
		var dateTime = UnixtimeToDatetime(unixTime, true);
		console.log(unixTime);
		console.log(dateTime);
		
		
//		$.post('<?php echo U("index/test");?>', '{"a":"1","b":"2"}', function(data){
