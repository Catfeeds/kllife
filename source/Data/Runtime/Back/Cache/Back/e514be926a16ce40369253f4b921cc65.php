						...
						<div class="create-write" data-id="">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">机构名称</i>
										</div>
								...
								<div class="col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">机构类型</i>
										</div>
										<script type="text/javascript">
											$(document).ready(function(){
												bindTypeDataDropMenu($('.data_agency_type'), 'cj_agency_type', '选择机构类型');
											});
										</script>
										<input type="text" class="form-control data_agency_type">
									</div>
								</div>
								<div class="col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">区位</i>
										</div>
										<input type="text" class="form-control data_area" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="input-group">
										...
										<script type="text/javascript">
											$(document).ready(function(){
												bindAdminDropMenu($('.data_admin'), 'operator', '选择负责计调', false, false);
											});
										</script>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">机构地址:</i>
										</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">首选领队</i>
										</div>
										<!--<script type="text/javascript">
											$(document).ready(function(){
												var ds = {tab:'cj_leader', show_col:'name', cdsstr: 'invalid|=|0', cdtype:3}
												bindSelect2DropMenu($('.data_first_leader'), ds, '选择领队', 1, true);
											});
										</script>-->
										<input type="text" class="form-control data_first_leader" placeholder="多个领队请用','隔开">
									</div>
								</div>
								<div class="col-md-6">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">差评领队</i>
										</div>
										<!--<script type="text/javascript">
											$(document).ready(function(){
												var ds = {tab:'cj_leader', show_col:'name', cdsstr: 'invalid|=|0', cdtype:3}
												bindSelect2DropMenu($('.data_bad_leader'), ds, '选择领队', 1, true);
											});
										</script>-->
										<input type="text" class="form-control data_bad_leader" placeholder="多个领队请用','隔开">
									</div>
								</div>
							</div>
							...
							<div class="row">	
								<div class="col-md-6">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">首选酒店</i>
										</div>
										<!--<script type="text/javascript">
											$(document).ready(function(){
												var ds = {tab:'cj_hotel', show_col:'name', cdsstr: 'invalid|=|0', cdtype:3}
												bindSelect2DropMenu($('.data_first_hotel'), ds, '选择酒店', 1, true);
											});
										</script>-->
										<input type="text" class="form-control data_first_hotel" placeholder="多个酒店请用','隔开">
									</div>
								</div>
								<div class="col-md-6">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">差评酒店</i>
										</div>
										<!--<script type="text/javascript">
											$(document).ready(function(){
												var ds = {tab:'cj_hotel', show_col:'name', cdsstr: 'invalid|=|0', cdtype:3}
												bindSelect2DropMenu($('.data_bad_hotel'), ds, '选择酒店', 1, true);
											});
										</script>-->
										<input type="text" class="form-control data_bad_hotel" placeholder="多个酒店请用','隔开">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">法人代表</i>
										</div>
										<input type="text" class="form-control data_juridical_person" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i style="font-style: normal;">法人电话</i>
										</div>
										<input type="number" class="form-control data_juridical_person_mob" maxlength="11" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="input-group">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="input-group">
										...
										<script type="text/javascript">
											$(document).ready(function(){
												bindTypeDataDropMenu($('.data_pay_type'), 'cj_pay_type', '选择结算类型');
											});
										</script>
				...
				<div class="panel-body">						
					...
					<div class="issuing-list">
						...
						<div class="issuing-list-search">
							<div class="input-group">
								<input type="text" class="form-control" placeholder="搜索内容可以是编号、所属线路、名称、区位、地址、法人、法人电话、联系人、联系人电话、开户行">
							...
							<table class="table table-bordered table-striped dataTable no-footer" id="table_list" role="grid" aria-describedby="example-2_info">
								<thead>
									<tr role="row" class="head">
										...
										<th class="sorting" rowspan="1" colspan="1" style="width: 80px;">机构类型</th>
										<th class="sorting" rowspan="1" colspan="1" style="width: 80px;">区位</th>
										<th class="sorting" rowspan="1" colspan="1" style="width: 80px;">负责计调</th>
										<th class="sorting" rowspan="1" colspan="1" style="width: 150px;">酒店(首选/差评)</th>
										<th class="sorting" rowspan="1" colspan="1" style="width: 150px;">领队(首选/差评)</th>
										<th class="sorting" rowspan="1" colspan="1" style="width: 150px;">法人</th>
										...
										<th class="sorting" rowspan="1" colspan="1" style="width: 150px;">机构地址</th>
								...
								<tbody class="middle-align list-tbody">
									<?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ds): $mod = ($i % 2 );++$i; if($key % 2 == 0): ?><tr role="row" class="odd" data-id="<?php echo ($ds["id"]); ?>">
										<?php else: ?>
											...
											<?php $agencyType = json_decode($ds['agency_type'], true); $admin = json_decode($ds['admin'], true); ?>
											<td><?php echo ($ds["id"]); ?></td>
											<td><?php echo ($ds["name"]); ?></td>
											<td><?php echo ($agencyType["type_desc"]); ?></td>
											<td>区位:<?php echo ($ds["area"]); ?><br />所属线路:<?php echo ($ds["line_show"]); ?></td>
											<td><?php echo ($admin["account"]); ?></td>
											<td>首选酒店:<br /><?php echo ($ds["first_hotel"]); ?><br/>差评酒店:<br /><?php echo ($ds["bad_hotel"]); ?></td>
											<td>首选领队:<br /><?php echo ($ds["first_leader"]); ?><br/>差评领队:<br /><?php echo ($ds["bad_leader"]); ?></td>
											<td><?php echo ($ds["juridical_preson"]); ?><br /><?php echo ($ds["juridical_person_mob"]); ?></td>
...
<script type="text/javascript">
	...
	function clearInfo() {
		...
		$('.data_name').val('');
		setSelect2Value($('.data_agency_type'), null);
		setSelect2Value($('.data_line'), null);
		$('.data_area').val('');
		setSelect2Value($('.data_admin'), null);
		$('.data_address').val('');
		$('.data_first_leader').val('');
		$('.data_bad_leader').val('');
		$('.data_first_hotel').val('');
		$('.data_bad_hotel').val('');
//		setSelect2Value($('.data_first_leader'), null);
//		setSelect2Value($('.data_bad_leader'), null);
//		setSelect2Value($('.data_first_hotel'), null);
//		setSelect2Value($('.data_bad_hotel'), null);
		$('.data_juridical_person').val('');
		$('.data_juridical_person_mob').val('');
		$('.data_contacts').val('');
	...
	$('.btn-save').click(function(){
		var firstLeader = $('.data_first_leader').val().replace('，', ',');
		var badLeader = $('.data_bad_leader').val().replace('，', ',');
		var firstHotel = $('.data_first_hotel').val().replace('，', ',');
		var badHotel = $('.data_bad_hotel').val().replace('，', ',');
		var jsonData = {
			op_type: 'save',
			src: 'agency',
			...
			name: $('.data_name').val(),
			agency_type: getSelect2Value($('.data_agency_type')),
			area: $('.data_area').val(),
			admin: getSelect2Value($('.data_admin'),['id','account']),
			address: $('.data_address').val(),
			first_leader: firstLeader,
			bad_leader: badLeader,
			first_hotel: firstHotel,
			bad_hotel: badHotel,
//			first_leader: getSelect2Value($('.data_first_leader'),['id','name']),
//			bad_leader: getSelect2Value($('.data_bad_leader'),['id','name']),
//			first_hotel: getSelect2Value($('.data_first_hotel'),['id','name']),
//			bad_hotel: getSelect2Value($('.data_bad_hotel'),['id','name']),
			juridical_person: $('.data_juridical_person').val(),
			juridical_person_mob: $('.data_juridical_person_mob').val(),
		...
		$.post('<?php echo U("financial/source");?>', jsonData, function(data){
			if (data.result.errno == 0) {
				if (data.op != null && data.op == 'create') {
					location.href = '<?php echo U("financial/source");?>/src/agency';
				} else {
					if (data.ds != null) {
						var d = data.ds;
						...
						if (d.agency_type != null && d.agency_type != '') {
							var agencyType = $.parseJSON(d.agency_type);
							$(trObj).find('td:eq(2)').html(agencyType.type_desc);							
						}
						$(trObj).find('td:eq(3)').html('区位:'+d.area+'<br />所属线路:'+d.line_show);
						if (d.admin != null && d.admin != '') {
							var admin = $.parseJSON(d.admin);
							$(trObj).find('td:eq(4)').html(admin.account);							
						}
						var hotel = '';
						if (d.first_hotel != null && d.first_hotel != '') {
							hotel = '首选酒店:<br />'+d.first_hotel;
						}
						if (d.bad_hotel != null && d.bad_hotel != '') {
							if (hotel != '') {
								hotel += '<br />';
							}
							hotel += '差评酒店:<br />'+d.bad_hotel;
						}
						if (hotel != '') {
							$(trObj).find('td:eq(5)').html(hotel);	
						}
						var leader = '';
						if (d.first_leader != null && d.first_leader != '') {
							leader = '首选领队:<br />'+d.first_leader;
						}
						if (d.bad_leader != null && d.bad_leader != '') {
							if (leader != '') {
								leader += '<br />';
							}
							leader += '差评领队:<br />'+d.bad_leader;
						}
						if (leader != '') {
							$(trObj).find('td:eq(6)').html(leader);	
						}						
						$(trObj).find('td:eq(7)').html(d.juridical_person+'<br />'+d.juridical_person_mob);
						$(trObj).find('td:eq(8)').html(d.contacts+'<br />'+d.contacts_mob);
						$(trObj).find('td:eq(9)').html('收款人:'+d.payee+'<br />卡号:'+d.bank_card+'<br />开户行:'+d.bank_address+'<br />结算方式:'+d.pay_type_show);
	...
	var itemObjs = {};
	function itemData(){
		var agencyId = $(this).closest('tr').attr('data-id');
		var itemObj = itemObjs['item_'+agencyId];
		if (itemObj == null) {
			itemObj = new ModalCJItem(this, 'agency', agencyId);
			itemObjs['item_'+agencyId] = itemObj;
		}	
		itemObj.showItems();
	}
	...
	function editData(){
		...
		$.post('<?php echo U("financial/source");?>', {op_type:'find', src:'agency', id:did}, function(data){
			if (data.ds != null) {
				var d = data.ds;
				$('.create-write').attr('data-id', d.id);
				$('.data_name').val(d.name);
				setSelect2Value($('.data_agency_type'), d.agency_type);
				setSelect2Value($('.data_line'), d.line);
				$('.data_area').val(d.area);
				setSelect2Value($('.data_admin'), d.admin);
				$('.data_address').val(d.address);
				$('.data_first_leader').val(d.first_leader);
				$('.data_bad_leader').val(d.bad_leader);
				$('.data_first_hotel').val(d.first_hotel);
				$('.data_bad_hotel').val(d.bad_hotel);
//				setSelect2Value($('.data_first_leader'), d.first_leader);
//				setSelect2Value($('.data_bad_leader'), d.bad_leader);
//				setSelect2Value($('.data_first_hotel'), d.first_hotel);
//				setSelect2Value($('.data_bad_hotel'), d.bad_hotel);
				$('.data_juridical_person').val(d.juridical_person);
				$('.data_juridical_person_mob').val(d.juridical_person_mob);
	...
	function deleteData() {
		...
		var trObj = $(this).closest('tr');
		var did = $(trObj).attr('data-id');
		$.post('<?php echo U("financial/source");?>', {op_type:'delete', src: 'agency', id:did}, function(data){
			if (data.result != null) {
				if (data.result.errno == 0) {
					toastr.success(data.result.message);
					$(trObj).remove();
				...
				if (data.ds != null && data.ds != 'undefined') {	
					for (var i = 0; i < data.ds.length; i ++){
						...
						var vhtml =	'<tr role="row" class="'+trClass+'" data-id="'+d.id+'">';
							...
							if (d.agency_type != null && d.agency_type != '') {
								var agencyType = $.parseJSON(d.agency_type);
								vhtml +='	<td>'+agencyType.type_desc+'</td>';
							} else {
								vhtml +='	<td></td>';
							}
							vhtml +='	<td>区位:'+d.area+'<br />所属线路:'+d.line_show+'</td>';
							if (d.admin != null && d.admin != '') {
								var admin = $.parseJSON(d.admin);
								vhtml +='	<td>'+admin.account+'</td>';							
							} else {
								vhtml +='	<td></td>';
							}
							var hotel = '';
							...
							vhtml +='	<td>'+leader+'</td>';
							vhtml +='	<td>'+d.juridical_person+'<br />'+d.juridical_person_mob+'</td>';
