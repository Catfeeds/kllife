	...
	function initDataTable() {	
		var vTable = $("#example-1").dataTable({
			...
			"aoColumns": [
				...
				{"mData": "lineid.title", "aTargets": [1], "fnCreatedCell": replaceContent},
				{"mData": "admin.account", "aTargets": [2], "fnCreatedCell": replaceContent},
				{"mData": "male", "aTargets": [3]},
				{"mData": "woman", "aTargets": [4]},
				{"mData": "child", "aTargets": [5]},
				{"mData": "review_type_id.type_desc", "aTargets": [6], "fnCreatedCell": replaceContent},
...
//		alert(JSON.stringify(oData['review_complate']));
	...
	function _editFun(aid, bComplate) {
		$.getJSON("<?php echo U('review/changeCount');?>", {op:'review_response', id:aid, complate: bComplate}, function(data){
