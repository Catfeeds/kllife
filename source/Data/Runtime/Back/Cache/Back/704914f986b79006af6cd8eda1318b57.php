...
<style>
	...
	<div class="row">
		...
		<div class="panel-body">
			...
			<div class="issuing-coupon-search" style="width: 70%; margin: 20px auto;">
				<div class="input-group">
					<input type="text" class="form-control search_input" placeholder="搜索内容可以是审核编号、团期编号、提审人员、审批人员、确认人员、收款人、收款账号、开户行地址,另外您可以在输入搜索内容后肆无忌惮的敲下回车键进行搜索...祝您查找愉快!!!">
					<div class="input-group-addon search_button" style="background-color: #68b828; color: #fff; cursor: pointer; padding: 4px 40px; ">
...
//		alert(nTd+'|'+JSON.stringify(sData)+'|'+JSON.stringify(oData)+'|'+iRow+'|'+iCol);  
		...
		if (oData['team_id'] == null || oData['team_id'] == '') {
			$(nTd).html('<a href="'+'<?php echo U("financial/deposit");?>/op/new/id/'+id+'" class="btn btn-secondary btn-sm btn-icon icon-left" target="_blank">查看请款</a>');
		}
		$(nTd).html('<a href="'+'<?php echo U("financial/deposit");?>/id/'+id+'" class="btn btn-secondary btn-sm btn-icon icon-left" target="_blank">审批详细</a>');
	}
