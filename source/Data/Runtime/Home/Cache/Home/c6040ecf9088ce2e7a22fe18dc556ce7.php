...
<link rel="stylesheet" href="/source/Static/home/css/xinjiang.css">
<style type="text/css">
	.theme { background: #fd4e4e; padding:1px 6px 1px 6px; color:#fff;text-align: center;text-align: -webkit-center; }
</style>
<div class="xinjiang">
    <div class="banner"></div>
    <a href="http://shequ.kllife.com/Index/youjidetail.html?id=3049" target="_blank"></a>
    <div class="chart">
    </div>
    <!--<div style="width:1200px;margin:auto;"><a href="http://pqt.zoosnet.net/lr/chatpre.aspx?id=pqt43116159&lng=cn&r=&rf1=&rf2=&p=http%3A//kllife.com/home/index.php%3Fs%3D/home/subject/xinjiang&cid=1497598677796708383968&sid=1499908846033380364902" target="_blank"><img src="/source/Static/home/images/xinjiang/xinjiang-kefu.jpg" alt="" /></a></div>-->
    <div class="show">
        <img src="/source/Static/home/images/xinjiang/xinjiang_select.png" alt="">
    </div>
    <!--<div class="select">
        <div class="to-go">
            <div class="img3">
                <img src="/source/Static/home/images/xinjiang/select3.png" alt="">
                <div class="spot">
                    <div>
                        <span>禾木</span>
                        <span>喀纳斯</span>
        ...
        <div class="selecttwo">
            <div class="img3">
                <img src="/source/Static/home/images/xinjiang/select4.png" alt="">
                <div class="season">
                    <span data-val="spring">春季</span>
                    <span data-val="summer">夏季</span>
                    <span data-val="autumn">秋季</span>
                    <span data-val="winter">冬季</span>
                </div>
                <div class="interest">
                    <span>徒步</span>
                    <span>骑马</span>
                ...
                <div class="price">
                    ...
                    <span data-min-val="4000" data-max-val="5000">4000-5000</span>
                    <span data-min-val="5001">5000以上</span>
                </div>
                <div class="day">
                    <span data-min-val="6" data-max-val="8">6天-8天</span>
                    <span data-min-val="9" data-max-val="11">9天-11天</span>
                    <span data-min-val="12">11天以上</span>
                </div>
            </div>
        </div>
    </div>-->
    ...
    <div class="goods-group line_container recommend">
    	<div class="content">
    		<div class="tit">
	            <ul class="recommend_filter" style="width:552px;">
	                <?php if(is_array($subject_line_tab_xinjiang)): $i = 0; $__LIST__ = $subject_line_tab_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i;?><li data-tab="<?php echo ($tab["type_key"]); ?>"><?php echo ($tab["type_desc"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
	            </ul>
	        </div>
    	</div>
    	<!--<?php if(is_array($dest_line_xinjiang)): $k = 0; $__LIST__ = $dest_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($k % 2 );++$k;?><div class="item" data-id="<?php echo ($l["id"]); ?>" style="z-index:90;">
		        <div class="img"><img src="<?php echo ($l["img1"]); ?>" alt=""><p><span class="day"><?php echo ($l["travel_day"]); ?></span>日游</p></div>
		        <?php if(empty($l['line_especial_icon']) == false): ?><div class="today-hot">
						<img src="/source/Static/home/images/index_img/<?php echo ($l['line_especial_icon']); ?>" alt="">
					</div><?php endif; ?>
		        <div class="tit">
    ...
    <!--新疆金秋-->
    <div class="item template_item1 hidden_ctrl" data-id="">
        <div class="left">
        	<img class="line_image" src="" alt="">
			<div class="today-hot">
				<img src="" alt="">
			</div>
        </div>
        <div class="right">
            ...
            <p class="brief">线路简介：<span class="send_word"></span></p>
    ...
    <div style="background: #ffffea;">
    	<div class="recommend recommend1">
	        <div class="content">
	            <?php if(is_array($subject_line_xinjiang)): $i = 0; $__LIST__ = $subject_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($l["id"]); ?>">
		            	<div class="left">
		            		<img class="line_image" src="<?php echo ($l["img1"]); ?>" alt="">
		            		<?php if(empty($l['line_especial_icon']) == false): ?><div class="today-hot">
									<img src="/source/Static/home/images/index_img/<?php echo ($l['line_especial_icon']); ?>" alt="">
								</div><?php endif; ?>
		            	</div>
		                <div class="right">
		                    <h1 class="title"><?php echo ($l["title"]); ?></h1><span class="<?php echo ($l['theme_type_list'][0]['type_key']); ?>" style="margin-left:10px;padding:2px 5px !important;"><?php echo ($l["theme_type_show_text"]); ?></span>
		                    <p class="subheading"><?php echo ($l["subheading"]); ?></p>
		                    <p class="brief">线路简介：<span class="send_word"><?php echo ($l["send_word_show"]); ?></span></p>
		                    <div class="choice-time">
	    ...
	    <div class="customized">
	        <div class="earth"><img src="/source/Static/home/images/xinjiang/earth.gif" alt=""></div>
	        <div class="customized1"><img src="/source/Static/home/images/xinjiang/customized1.png" alt=""></div>
	        <div class="customized2"><img src="/source/Static/home/images/xinjiang/customized2.png" alt=""></div>
	        <a href="<?php echo U('line/book');?>" class="btn btn-customized" target="_blank">定制我的旅行</a>
	    </div>
	    <!--活动回顾-->
	    <div class="review">
	        <div class="goods-group">
	            <div class="review-img"><img src="/source/Static/home/images/xinjiang/review.png" alt=""></div>
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-07-14_57873ece175e4.jpg" alt=""></div>
	                <div class="tit">
	                    <p>新疆天山9日环游记</p>
	                </div>
	                <a href="http://shequ.kllife.com/Index/youjidetail/id/1438.html" target="_blank"></a>
	            </div>
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-10-14_5800e59965059.jpg" alt=""></div>
	                <div class="tit">
	                    <p>金秋，行走在迷人的北疆--北疆九日游</p>
	                </div>
	                <a href="http://shequ.kllife.com/Index/youjidetail/id/1966.html" target="_blank"></a>
	            </div>
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-10-13_57ff241ad12ae.jpg" alt=""></div>
	                <div class="tit">
	                    <p>这里是新疆，一个美丽的地方！</p>
	                </div>
	                <a href="http://shequ.kllife.com/Index/youjidetail/id/1960.html" target="_blank"></a>
	            </div>
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-10-26_5810bb50157de.jpg" alt=""></div>
	                <div class="tit">
	                    <p>2016额济纳全景游——赴一场黄金盛宴</p>
	                </div>
	                <a href="http://shequ.kllife.com/Index/youjidetail/id/2026.html" target="_blank"></a>
	            </div>
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-11-30_583e6c0cbffef.jpg" alt=""></div>
	                <div class="tit">
	                    <p>西北行漫记——大漠传奇意象</p>
	                </div>
	            ...
	            <div class="item">
	                <div class="img"><img class="img-responsive" src="/source/Static/home/images/xinjiang/youji2016-10-17_5804e218278b0.jpg" alt=""></div>
	                <div class="tit">
	                    <p>菲林下的西域，带着胶卷游新疆（反转片）</p>
	                </div>
	                <a href="http://shequ.kllife.com/Index/youjidetail/id/1972.html" target="_blank"></a>
	            </div>
	        </div>
	    </div>
	    <!--<?php echo p_a($cache_test);?>-->
    <div class="xiaotuanman">
	    ...
	    <!--推荐线路-->
	    <div class="goods-group goods-group-two">
	        <div class="left">
	            <div class="abso1"><img src="/source/Static/home/images/xinjiang/recommend1.png" alt=""></div>
	            <div class="abso2"><img src="/source/Static/home/images/xinjiang/recommend2.gif" alt=""></div>
	        </div>
	        <div class="right">
	        	<?php if(is_array($recommend)): $i = 0; $__LIST__ = $recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rd): $mod = ($i % 2 );++$i;?><div class="item">
	                    ...
	                    <?php if(empty($rd['line_especial_icon']) == false): ?><div class="today-hot">
								<img src="/source/Static/home/images/index_img/<?php echo ($rd['line_especial_icon']); ?>" alt="">
							</div><?php endif; ?>
		                <div class="tit">
...
<div class="arcitle_con" style="display: none;">
	<h2>新闻资讯</h2>
	<p><a href="<?php echo U('line/news');?>/classid/1/" target="_blank">更多</a></p>
	<ul class="arcitle_li">
...
<!--咨询-->
<div class="advice">
	<a href="<?php echo ($pcset["askfor_link"]); ?>" target="_blank"><img src="/source/Static/home/images/xinjiang/tel.png" alt=""></a>
</div>
<div class="GPopup" style="background: rgba(0,0,0,0.5);width:100%;height:100%;position: fixed;top:0px;left:0px;z-index:1000;">
    <div style="text-align: center;text-align: -webkit-center;margin-top:12%;">
        <span style="position: relative;display: inline-block;cursor: pointer;">
            <img src="/source/Static/home/images/xinjiang/promotion.jpg" alt="">
...
<script>
    //关闭促销弹框
    $(".GPopup").on("click",function(){
        $(this).fadeOut("slow");
    })

	//新疆金秋标签切换
	$(".recommend_filter li:first").addClass('active');
    $(".recommend_filter li").on("click",function(){
        ...
        $.post('<?php echo U("subject/xinjiang");?>', jsonData, function(data){
            ...
            $('.recommend').find('.content').find('.item').remove();
            if (data.ds != null) {
                for (var i=0; i < data.ds.length; i++) {
                    var d = data.ds[i];
                    var itemObj = $('.template_item1').clone();
                    $(itemObj).removeClass('hidden_ctrl');
                    $(itemObj).removeClass('template_item1');
                    ...
                    $('.recommend1').find('.content').append(itemObj);
                }
        ...
        $.post('<?php echo U("subject/xinjiang");?>', jsonData, function(data){
            if (data.ds != null) {
                for (var i=0; i < data.ds.length; i++) {
                    ...
                    if (d.line_especial_icon == 0) {
						$(rootObj).find('.today-hot').remove();
					}
                    if (d.check_price == 0) {
                        $(rootObj).find('.tit .money').find('.sm1 .lg1').html('<span class="lg1">核算中</span>');
                    } else {
