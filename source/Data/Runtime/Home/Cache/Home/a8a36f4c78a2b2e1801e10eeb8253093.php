...
<!-- Not found text -->
	...
	<div class="not-found-text">
		...
		<?php if(empty($err['content']) == false): ?><h2 class="not-found-text"><?php echo ($err["content"]); ?></h2><?php endif; ?>
		<?php if(empty($err['reason']) == false): ?><h3 class="not-found-text"><?php echo ($err["reason"]); ?></h3><?php endif; ?>
		<?php if(empty($err['suggest']) == false): ?><h4 class="not-found-text"><?php echo ($err["suggest"]); ?></h4><?php endif; ?>
    </div>
