...
<div class="xinjiang">
    ...
    <a href="http://shequ.kllife.com/Index/youjidetail.html?id=3049" target="_blank"><div class="chart2"></div></a>
    <div class="chart">
        <img src="/source/Static/home/images/xinjiang/chart1.png" alt="">
    </div>
    ...
    <div class="show">
        ...
        <div id="show"><img src="/source/Static/home/images/xinjiang/click_me.png" alt=""></div>
    </div>
    <div class="select">
        <div class="to-go">
            <div class="img3">
            ...
            <!--<img class="img2" data-ceho="/source/Static/home/images/xinjiang/select2.gif" alt="">-->
        </div>
        <div class="selecttwo">
            <div class="img3">
    ...
    <div class="goods-group line_container">
    	<?php if(is_array($dest_line_xinjiang)): $i = 0; $__LIST__ = $dest_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($l["id"]); ?>" style="z-index:90;">
    ...
    <div style="background: #ffffea;">
    	...
    	<div class="show">
        	<img src="/source/Static/home/images/xinjiang/xinjiang_select2.png" alt="">
    	</div>
    	<div class="recommend recommend1">
	        <div class="content">
	            ...
	            <?php if(is_array($subject_line_xinjiang)): $i = 0; $__LIST__ = $subject_line_xinjiang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="item" data-id="<?php echo ($l["id"]); ?>">
		                ...
		                <div class="right">
		                    <h1 class="title"><?php echo ($l["title"]); ?></h1><span class="<?php echo ($l['theme_type_list'][0]['type_key']); ?>"><?php echo ($l["theme_type_show_text"]); ?></span>
...
<script>
        ...
        $.post('<?php echo U("subject/xinjiang");?>', jsonData, function(data){
            ...
            if (data.ds != null) {
                for (var i=0; i < data.ds.length; i++) {
                    ...
                    $('.recommend').find('.content').append(itemObj);
                }
    ...
    function findLine() {
        ...
        $.post('<?php echo U("subject/xinjiang_test");?>', jsonData, function(data){
            if (data.ds != null) {
                for (var i=0; i < data.ds.length; i++) {
                    var d = data.ds[i];
