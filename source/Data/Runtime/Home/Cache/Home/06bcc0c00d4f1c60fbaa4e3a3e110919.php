...
<style type="text/css">
	...
	<div id="content">
		...
		<div class="list-menu">
			...
			<?php if(empty($lines) == true): ?><span class="no-more-data" style="text-indent:2em;"></span><?php endif; ?>
			...
			<div class="single-row">
				<?php if(is_array($lines)): $i = 0; $__LIST__ = $lines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$line): $mod = ($i % 2 );++$i;?><div class="single-row-content" data-id="<?php echo ($line["id"]); ?>">
						...
						<div class="single-row-describe">
							<div class="single-row-describe-top">
								<h4 class="title">【<?php echo ($line["title"]); ?>】<span class="span"></span><span class="subheading"><?php echo ($line["subheading"]); ?></span></h4>
		...
		<div class="special main">
			...
			<div class="special-exhibition">
				...
				<ul>
					...
					<?php $__FOR_START_1133020613__=0;$__FOR_END_1133020613__=12;for($k=$__FOR_START_1133020613__;$k < $__FOR_END_1133020613__;$k+=1){ $zt = $set_subjects['zhuanti'.$k]; if (empty($zt['url'])) { continue; } ?>
...
//			console.log(JSON.stringify(jsonData));
            ...
            bLoading = true;
			$.post('<?php echo U("line/search");?>', jsonData, function(data){
                bLoading = false;
