...
<body>
	...
	<div id="content">
		<div class="article-list">
			<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i; if(empty($art['face_image']) == true): ?><div class="article-information-word">				
						<a href="<?php echo U('line/news');?>/id/<?php echo ($art["id"]); ?>"></a>			
						<div class="article-information-word-div">
							<h3><?php echo ($art["title"]); ?></h3>
							<?php if($art['send_word_simple'] == 1): ?><p><?php echo ($art["send_word_show"]); ?><a href="<?php echo U('line/news');?>/id/<?php echo ($art["id"]); ?>"></a></p>
							<?php else: ?>
	...
	<script type="text/javascript">
		...
		$('.load-more a').click( function () {
			...
			$.post('<?php echo U("line/news");?>', jsonData, function(data){
					...
					if (typeof(data.ds) != 'undefined' && data.ds != null) {
						...
						for (var i=0; i<data.ds.length; i++) {
							...
							if (include_image == false) {
								...
								vhtml +='	<a href="'+'<?php echo U("line/article");?>/id/'+d.id+'"></a>';
