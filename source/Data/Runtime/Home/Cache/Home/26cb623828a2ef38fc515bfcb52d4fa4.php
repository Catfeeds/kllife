...
<body>
	...
	<!-- 私有样式 -->
	<link rel="stylesheet" href="/source/Static/home/css/service_center.css">
	<div id="content">
		<div class="service-center">
			<img src="/source/Static/home/images/service_center_img/welcome.jpg" alt="">
			<div class="self-service">
				<h3>自助服务</h3>
				<div class="self-service-content">
					<ul>
						<li>
							<a href="<?php echo U('line/order');?>/type/center" target="_blank">
								<i class="order-inquiry"></i>
								<p>订单查询</p>
							</a>
						</li>
						<li>
							<a href="<?php echo U('user/info');?>" target="_blank">
								<i class="individual-account"></i>
								<p>个人账户</p>
							</a>
						</li>
						<li>
							<a href="<?php echo U('user/forgot');?>" target="_blank">
								<i class="find-psd"></i>
								<p>找回密码</p>
							</a>
						</li>
						<li class="clear-right-border">
							<a href="http://kllife.com/home/index.php?s=/home/service/question/id/391" target="_blank">
								<i class="travel-agent-qualification"></i>
								<p>旅行社资质</p>
							</a>
						</li>
						<li class="clear-bottom-border">
							<a href="<?php echo U('user/info');?>/jump/my_score" target="_blank">
								<i class="integral-query"></i>
								<p>积分查询</p>
							</a>
						</li>
						<li class="clear-bottom-border">
							<a href="javascript:;" target="_blank">
								<i class="tourism-preference"></i>
								<p>旅游优惠</p>
							</a>
						</li>
						<li class="clear-bottom-border">
							<a href="http://kllife.com/home/index.php?s=/home/service/question/id/38" target="_blank">
								<i class="payment-method"></i>
								<p>支付方式</p>
							</a>
						</li>
						<li class="clear-right-border clear-bottom-border">
							<a href="http://kllife.com/zt/pc/sheyingsq/" target="_blank">
								<i class="join-community"></i>
								<p>加入社群</p>
							</a>
						</li>
					</ul>
			...
			<div class="common-problem">
				...
				<div class="common-problem-content">
					<ul>
						<?php if(is_array($service_question)): $i = 0; $__LIST__ = $service_question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qt): $mod = ($i % 2 );++$i;?><li class="<?php echo ($qt["class"]); ?>">
								<h4><?php echo ($qt["type_desc"]); ?></h4>
								<?php if(is_array($qt["questions"])): $i = 0; $__LIST__ = $qt["questions"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$quest): $mod = ($i % 2 );++$i;?><!--选中A标签添加checked-problem类-->
									<p><a href="<?php echo U('service/question');?>/id/<?php echo ($quest["id"]); ?>" target="_blank"><?php echo ($quest["content"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
			</div>
			...
			<div class="customer-service">
				...
				<div class="customer-service-content">
					<ul>
						<li>
							<img src="/source/Static/home/images/service_center_img/2.jpg" alt="">
							<a href="<?php echo ($pcset["askfor_link"]); ?>" target="_blank">在线咨询</a>
							<p>为你解决遇到的问题</p>
						</li>
						<li class="clear-right-border">
							<img src="/source/Static/home/images/service_center_img/1.jpg" alt="">
							<i>400-080-5860</i>
							<p>9:00-20:00全年无休</p>
						</li>
					</ul>
