...
<!-- Not found text -->
	...
	<div class="not-found-text">
		<?php if(empty($err['title']) == false): ?><h1 class="not-found-text"><?php echo ($err["title"]); ?></h1><?php endif; ?>
		<?php if(empty($err['content']) == false): ?><h2 class="not-found-text"><?php echo ($err["content"]); ?></h1><?php endif; ?>
		<?php if(empty($err['reason']) == false): ?><h3 class="not-found-text"><?php echo ($err["reason"]); ?></h1><?php endif; ?>
		<?php if(empty($err['suggest']) == false): ?><h4 class="not-found-text"><?php echo ($err["suggest"]); ?></h1><?php endif; ?>
    </div>
...
function initErrorNo() {
	...
	for (var i = 0; i < $(errnoList).length; i ++) {		
		$('.graphic').append('<img src="/source/Static/home/images/404_img/'+errnoList[i]+'.png"/>');
	}
}
