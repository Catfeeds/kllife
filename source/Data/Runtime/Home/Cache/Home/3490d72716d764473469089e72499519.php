...
<head>
	...
	<?php if(strpos($_SERVER['HTTP_HOST'], '.kllife.com') !== FALSE): ?><meta name="robots" content="noindex,follow"><?php endif; ?>	
	<!--特殊专题新疆标题关键字-->
...
<button id="clickme" style="margin-top:200px;">click</button>
<script>
	$("#clickme").on("click",function(){
		$.ajax({
		    type: "post",
		    url: "http://kllife.com/home/index.php?s=/home/test/getMPVideoUrl",
		    data: {
		      MPurl: 'http://www.meipai.com/media/809168999'
		    },
		    dataType: "json",
		    success: function(e) {
				console.log(e);
