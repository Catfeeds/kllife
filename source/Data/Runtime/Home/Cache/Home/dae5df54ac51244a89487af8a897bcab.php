...
<div class="travel-arrangements">
	...
	<div class="travel-arrangements-content">
		...
		<div class="travel-arrangements-list">
			...
			<em>——</em>
			<?php $__FOR_START_703663154__=1;$__FOR_END_703663154__=$line['real_travel_day'];for($i=$__FOR_START_703663154__;$i <= $__FOR_END_703663154__;$i+=1){ ?><a class="day<?php echo ($i); ?>" href="#day<?php echo ($i); ?>">
		...
		<div class="special main">
			...
			<div class="special-exhibition">
				...
				<ul>
					...
					<?php $__FOR_START_1361069655__=0;$__FOR_END_1361069655__=12;for($k=$__FOR_START_1361069655__;$k < $__FOR_END_1361069655__;$k+=1){ $zt = $set_subjects['zhuanti'.$k]; if (empty($zt['url'])) { continue; } ?>
...
//  $(document).ready(function(){
		...
		function  addri(){
			...
			var number = 1;
			var tds = $("#calendarDiv div").eq(index).find("tr:first").find(".bg_black");
			var tdss = $("#calendarDiv div").eq(index).find("tr:nth-child(5)").find(".bg_black");
			var tdsss = $("#calendarDiv div").eq(index).find("tr:last").find(".bg_black")
