	...
	<div id="content">
		<div class="pay-success">
			<div class="success-information">
				<?php if(empty($state)): ?><img src="/source/Static/home/images/pay_success_img/error.png" alt="">
					<h3>订单已支付失败！</h3>
				<?php else: ?>
				...
				<?php if(empty($state)): ?><p><span> 错误信息：<strong><?php echo ($err_msg); ?></strong></span></p><?php endif; ?>
		...
		<div class="special main">
			...
			<div class="special-exhibition">
				...
				<ul>
					...
					<?php $__FOR_START_990455914__=0;$__FOR_END_990455914__=12;for($k=$__FOR_START_990455914__;$k < $__FOR_END_990455914__;$k+=1){ $zt = $set_subjects['zhuanti'.$k]; if (empty($zt['url'])) { continue; } ?>
