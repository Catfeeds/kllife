			...
			<div class="order-details-left">
				<div class="order-details-place">
					...
					<?php if(!empty($line["batchs"])): ?><div class="order-details-choose">
							...
							<div class="cfrq-choose">
								...
								<img src="/source/Static/home/images/content_img/down.png" alt="">
								<ul>
									<?php if(is_array($line["batchs"])): $i = 0; $__LIST__ = $line["batchs"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$batch): $mod = ($i % 2 );++$i;?><li data-id="<?php echo ($batch["id"]); ?>" data-title="<?php echo ($batch["title"]); ?>" data-price-adult="<?php echo ($batch["price_adult"]); ?>" data-price-child="<?php echo ($batch["price_child"]); ?>" data-use="<?php echo ($batch["can_use"]); ?>" data-invalid="<?php echo ($batch["signup_invalid"]); ?>" data-start-date-show="<?php echo ($batch["start_date_show"]); ?>">
						...
						<!-- 套餐内容开始 -->
						<?php if(empty($line['taocanList']) != true): ?><div class="order-details-choose tclx">
						...
						<div class="order-details-line-money">
							线路价格：
							<div class="xljg">
								<?php if(empty($tcp) == ture): ?><span>成人/￥<?php echo ($cur_batch['price_adult']); ?></span>
									<span>儿童/￥<?php echo ($cur_batch['price_child']); ?></span>
								<?php else: ?>
									<span>成人/￥<?php echo ($tcp['price_adult']); ?></span>
									<span>儿童/￥<?php echo ($tcp['price_child']); ?></span><?php endif; ?>
							</div>
						</div>
				...
				<div class="order-details-travel-people">
					...
					<div class="adult-div">
						...
						<?php $__FOR_START_165963650__=0;$__FOR_END_165963650__=$adult_count;for($m=$__FOR_START_165963650__;$m < $__FOR_END_165963650__;$m+=1){ ?><div class="adult-information">
								<div class="adult-information-num">
					...
					<div class="children-div">
						<?php $__FOR_START_259576393__=0;$__FOR_END_259576393__=$member_child_count;for($n=$__FOR_START_259576393__;$n < $__FOR_END_259576393__;$n+=1){ ?><div class="children-information">
								<div class="children-information-num">
	...
	<script type="text/javascript">
		jQuery(document).ready(
			function($){
				...
				//加载已选套餐
				var tcids = '<?php echo ($tcp["taocan_ids"]); ?>';
