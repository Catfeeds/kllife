...
<div class="page">
	<!-- mycss -->
	<link rel="stylesheet" href="http://kllife.com/source/Static/phone/css/help_center.css">
    ...
    $(".return-top").click(
		...
		<div class="content">
			...
			<div class="content-padded">
				<?php if(is_array($service_question)): $i = 0; $__LIST__ = $service_question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qt): $mod = ($i % 2 );++$i;?><div class="help-list">
						<h4>|<span><?php echo ($qt["type_desc"]); ?></span></h4>
						<?php if(is_array($qt["questions"])): $i = 0; $__LIST__ = $qt["questions"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$quest): $mod = ($i % 2 );++$i;?><!--选中A标签添加checked-problem类-->
							<a href="<?php echo U('service/question');?>/id/<?php echo ($quest["id"]); ?>" external><?php echo ($quest["content"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
