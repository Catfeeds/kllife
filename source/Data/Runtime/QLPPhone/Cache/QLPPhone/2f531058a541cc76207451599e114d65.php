	...
	<script type="text/javascript">		
		function browserRedirect() {
			...
			if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM)
			{
				...
				var vhref = window.location.href.replace(/m.xinlvpai/g,'xinlvpai').replace(/qlpphone/g,'qinglvpai');
...
<body>
    <div class="phone index list content">
        ...
        <div class="header">
            ...
            <div class="logo"><a href="javascript:;"><img class="animated bounceInDown" src="http://kllife.com/source/Static/qlpphone/common/images/logo-qinglvpai.png" alt=""></a>			</div>
