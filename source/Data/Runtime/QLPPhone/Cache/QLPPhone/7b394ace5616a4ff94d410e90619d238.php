...
<div class="phone index list">
	<div class="travel line">
		...
		<?php if(is_array($lines)): $i = 0; $__LIST__ = $lines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$line): $mod = ($i % 2 );++$i;?><a href="<?php echo U('line/content');?>/id/<?php echo ($line["id"]); ?>">
				<div class="item">
			...
			if (data.result.errno == 0) {
				if (data.ds != null && data.ds != 'undefined') {
					for (var i=0; i < data.ds.length; i++) {
						...
						var vhtml = '<a href="'+'<?php echo U("line/content");?>/id/'+d.id+'">'+
									'<div class="item">'+
								    ...
								    '    <a type="button" class="btn btn-orange-two" href="'+'<?php echo U("line/content");?>/id/'+d.id+'">查看线路</a>'+
								    '</div>'+
								    '</a>';
						$('.more').before(vhtml);
