...
<div class="index-line index-customized">
	<div class="center">
		...
		<!--<p style="text-align: center;text-align: -webkit-center;font-size: 18px;margin-bottom:15px;">拼个摄影师去旅行</p>-->
		<div class="place-name">
			<a class="table-btn active" href="javascript:;">你的每一刻美好都值得珍藏</a>
		</div>
		<div class="width">
			...
			<div class="right">
				<div>
					...
					<p class="color color-lg">给你拍最美跟拍游旅行照</p>
...
<div class="index-travel index-photographer" style="background: #fff;">
	...
	<div class="circuit">
		<?php if(is_array($leaders)): $i = 0; $__LIST__ = $leaders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leader): $mod = ($i % 2 );++$i;?><a href="<?php echo U('leader/info');?>/id/<?php echo ($leader["id"]); ?>" target="_blank">
				<div class="circuit-item">
					<div class="img"><img class="img-responsive" src="<?php echo ($leader["face_image"]); ?>" alt=""></div>
					<div class="name"><?php echo ($leader["show_name"]); ?></div>
				</div>
			</a><?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
	<a href="<?php echo U('leader/list');?>" target="_blank"><h3 class="whole">查看全部摄影师 <span><i class="iconfontyyy">&#xe624;</i></span></h3></a>
</div>
<!-小团慢旅行->
<div class="index-travel">
    ...
    <div class="circuit">
    	<?php $__FOR_START_1618350843__=1;$__FOR_END_1618350843__=5;for($i=$__FOR_START_1618350843__;$i < $__FOR_END_1618350843__;$i+=1){ $line = $set['slowly_line_'.$i]; ?>
	        <a href="<?php echo U('line/content');?>/id/<?php echo ($line["id"]); ?>" target="_blank">
	            <div class="circuit-item" style="border:1px solid #f5f5f5;">
...
<!--<div class="index-works" style="background: #333;">-->
    <!--&lt;!&ndash;<img class="img-responsive" src="http://kllife.com/source/Static/qinglvpai/images/index/index-works-background.png" alt="">&ndash;&gt;-->
    <!--<div class="absolute">-->
        <!--<h2>跟拍游作品</h2>-->
        <!--<?php $__FOR_START_727836422__=0;$__FOR_END_727836422__=6;for($i=$__FOR_START_727836422__;$i < $__FOR_END_727836422__;$i+=1){ ?>-->
        	...
        	<!--<a href="<?php echo U('article/info');?>/id/<?php echo ($art["id"]); ?>" target="_blank">-->
		        <!--<div class="works">-->
		            ...
		            <!--<div class="animated fresco"  data-id="<?php echo ($art["id"]); ?>">&lt;!&ndash;此div只用于遮罩层&ndash;&gt;</div>-->
		            <!--<span class="lg animated"><?php echo ($art["short_title"]); ?></span>-->
		            <!--<span class="sm animated">作者：<?php echo ($art["author"]); ?></span>-->
		        <!--</div>-->
	        <!--</a>-->
	    <!--<?php } ?>-->
        <!--<a href="<?php echo U('article/list');?>" target="_blank"><h3>查看全部跟拍游作品 <span><i class="iconfontyyy">&#xe624;</i></span></h3></a>-->
    <!--</div>-->
<!--</div>-->
<!--线路回顾-->
<!--<div class="index-review">-->
    <!--<h2>线路回顾</h2>-->
    <!--<?php $__FOR_START_256052515__=0;$__FOR_END_256052515__=3;for($i=$__FOR_START_256052515__;$i < $__FOR_END_256052515__;$i+=1){ ?>-->
...
<!--<div class="meikemei" style="position:fixed;top:0px;left:0px;width:100%;height:100%;background: rgba(0,0,0,0.5);z-index:10000000;">-->
	<!--<div id="meikemei-img" style="position: fixed;top:13%;left:0;right:0;margin:auto;width:456px;">-->
		<!--<div style="position: relative;">-->
			<!--<a href="<?php echo U('line/list');?>"><img style="width:100%;" src="http://kllife.com/source/Static/qinglvpai/images/index/pc-tc.png" alt=""></a>-->
			<!--<div id="remove-tc" style="position: absolute;top:20px;right:20px;cursor:pointer;z-index:11111111111111;"><img src="http://kllife.com/source/Static/phone/images/index/remove-tc.png" alt=""></div>-->
		<!--</div>-->
	<!--</div>-->
<!--</div>-->
...
//    })
    ...
    $(document).ready(function(){
        $("#meikemei-img").on("load",function(){
            ...
            var meikemeih = $(".meikemei").height();
            var top = (meikemeih-imgh)/2;
            var topRemove = top+1;
            alert(top)
            $(this).css("top",top+"px");
