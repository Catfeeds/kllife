...
define('__UPLOAD_PATH__', 'Upload/phone');

$c['SESSION_AUTO_START']            = false;
$c['DEFAULT_MODULE']                = 'Phone';
...
//    '{__GLOBAL_APPLICATION_URL__}'  => 'http:localhost/kllife/phone', //本地
...
//    '{__GLOBAL_HOST_URL__}'  		=> 'http://youzan.lechikeji.com', //nginx测试
    '{__GLOBAL_APPLICATION_URL__}'  => 'http://kllife.com/phone',
