...
define('__UPLOAD_PATH__', 'Upload/photo');

$c['SESSION_AUTO_START']            = false;
$c['DEFAULT_MODULE']                = 'Photo';
...
//    '{__TEMPLATE_THEME__}'          => '',
    ...
    '{__GLOBAL_APPLICATION_URL__}'  => 'http://localhost/kllife/photo', //本地
    '{__GLOBAL_HOST_URL__}'         => 'http://localhost', //本地
//    '{__GLOBAL_APPLICATION_URL__}'  => 'http://kllife.com/photo',
