...
define('__UPLOAD_PATH__', 'Upload/Fenxiao');
define('FX_IMAGE_UPLOAD_URL', '/source/Static/Upload/fenxiao/');
define('FX_IMAGE_UPLOAD_PATH', MB_ROOT.'source/Static/Upload/fenxiao/');

$c['SESSION_AUTO_START']            = false;
$c['DEFAULT_MODULE']                = 'Fenxiao';
...
//    '{__TEMPLATE_THEME__}'          => '',
    '{__GLOBAL_APPLICATION__}'      => '分销系统',
    '{__GLOBAL_APPLICATION_URL__}'  => 'http://kllife.com/fenxiao', //本地
