...
class SubjectController extends PhoneBaseController {
	...
	private function topSignupOrder($dest='', $showCount=20) {
		...
		if (!empty($dest)) {
			$conds = appendLogicExp('`q2`.`destination`', 'LIKE', '%'.$dest.'%');
		}		
